...
var Detail = $(function() {
    ...
    $("#addrow").on("click", function() {
        ...
        cols += `<td><input type="text" name="v_product_mill[]" id="v_product_mill${i}" readonly class="form-control form-control-sm text-right"></td>`;
        cols += `<td><input type="number" value="0" name="n_order[]" id="n_order${i}" class="form-control form-control-sm" onkeyup="itung(${i})" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\'></td>`;
