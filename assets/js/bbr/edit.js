...
var Detail = $(function() {
    ...
    $("#addrow").on("click", function() {
        ...
        cols += `<td><input type="number" autocomplete="off" class="form-control text-center n_order form-control-sm" value="0" name="n_order[]" id="n_order${i}"  onkeyup="hetang(${i}); miru(${i});" onblur=\'if(this.value==""){this.value="0";miru(${i})}\' onfocus=\'if(this.value=="0"){this.value="";}\'></td>`;
