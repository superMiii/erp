$(document).ready(function() {
    ...
    var Detail = $(function() {
        ...
        $("#addrow").on("click", function() {
            ...
            cols += `<td width="4%" class="clear" ${tex}><select data-nourut="${i}" class="form-control wajib select2-size-sm" name="i_rv_refference_type[]" id="i_rv_refference_type${i}"><option value=""></option></select></td>`;
            cols += `<td width="14%" class="clear" ${tex}><select data-nourut="${i}" class="form-control wajib select2-size-sm" name="i_rv_refference[]" id="i_rv_refference${i}"><option value=""></option></select></td>`;
