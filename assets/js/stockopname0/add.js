$(document).ready(function() {
    ...
    $("#i_area").select2({
        ...
        allowClear: true,
        ajax: {
            url: base_url + controller + "/get_areaku",
            dataType: "json",
            delay: 250,
            ...
            success: function(data) {
                if (data['detail_product'].length > 0) {
                    ...
                    for (let i = 0; i < data['detail_product'].length; i++) {
                        ...
                        // cols += `<td><input type="text" id="i_product${i}" value="${data['detail_product'][i]['i_product']}" readonly class="form-control form-control-sm"></td>`;
