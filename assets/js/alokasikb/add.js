$(document).ready(function() {
    ...
    var Detail = $(function() {
        ...
        $("#addrow").on("click", function() {
            ...
            cols += `<td><select class="form-control form-control-sm" id="eremark${i}" name="eremark[]"><option value=""></option><option value="-"> - </option><option value="Retur">Retur</option><option value="Biaya Promo">Biaya Promo</option><option value="Kurang Bayar">Kurang Bayar</option><option value="Kurang Bayar">Lebih Bayar</option><option value="Biaya Ekspedisi">Biaya Ekspedisi</option><option value="Biaya Administrasi">Biaya Administrasi</option></select></td>`;
