...
var Detail = $(function() {
    ...
    $("#addrow").on("click", function() {
        ...
        cols += `<td><input type="number" value="0" name="n_order[]" id="n_order${i}" class="form-control form-control-sm" onkeyup="hetang(${i});" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\'></td>`;
            ...
            if (ada) {
                ...
                $.ajax({
                    ...
                    success: function(data) {
                        ...
                        $("#n_stk" + z).val(data.detail[0]['n_stk']);
                    },
                    error: function() {
                        Swal.fire({
                            type: "error",
...
$('form').on('submit', function(e) { //bind event on form submit.
    ...
    if (formData) {
        ...
        if (total_deliver > 0 ) {
            ...
            Swal.fire('Total PENGEMBALIAN tidak boleh 0');
            return false;
        }
    }
});
...
function hetang(i) {
    ...
    if (qty > stok) {
        Swal.fire('Maaf Jumlah Pengembalian = ' + $('#n_order' + i).val() + ' Melebihi Stock = ' + $('#n_stk' + i).val());
