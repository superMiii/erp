            ...
            if (!ada) {
                ...
                if (formData) {
                    ...
                    if (total_deliver > 0 ) {
                        ...
                        Swal.fire('Total Kirim SJP tidak boleh 0');
                        return false;
                    }
                }
            } else {
...
function cek(i) {
    if (parseInt($('#n_deliver' + i).val()) > parseInt($('#n_stock' + i).val())) {
        ...
        Swal.fire('Maaf Jml Kirim = ' + $('#n_deliver' + i).val() + ', tidak boleh lebih dari Stok = ' + $('#n_stock' + i).val());
        $('#n_deliver' + i).val($('#n_stock' + i).val());
    } else if (parseInt($('#n_deliver' + i).val()) > parseInt($('#n_order' + i).val())) {
        // Swal.fire('Any fool can use a computer')
        Swal.fire('Maaf Jml Kirim = ' + $('#n_deliver' + i).val() + ', tidak boleh lebih dari ACC = ' + $('#n_order' + i).val());
