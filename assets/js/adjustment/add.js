$(document).ready(function() {
    ...
    var Detail = $(function() {
        ...
        $("#addrow").on("click", function() {
            ...
            cols += `<td><input type="number" value="0" name="n_adjustment[]" class="form-control n_adjustment form-control-sm" onblur=\'if(this.value==""){this.value="0";}\' onfocus=\'if(this.value=="0"){this.value="";}\'></td>`;
