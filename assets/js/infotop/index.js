$(document).ready(function() {
    ...
    var parameter = {
        ...
        i_customer_status: $("#i_customer_status").val(),
        i_customer_group: $("#i_customer_group").val(),
    };
    var right = [7];
    ...
    $("#i_price_group").select2({
        ...
        allowClear: true,
        ajax: {
            url: base_url + $("#path").val() + "/get_price_group",
            dataType: "json",
            delay: 250,
            data: function(params) {
                var query = {
    ...
    $("#i_customer_status").select2({
        dropdownAutoWidth: true,
        width: "100%",
        /* containerCssClass: "select-sm", */
        allowClear: true,
        ajax: {
            url: base_url + $("#path").val() + "/get_customer_status",
            dataType: "json",
            delay: 250,
            data: function(params) {
                var query = {
    ...
    $("#i_customer_group").select2({
        dropdownAutoWidth: true,
        width: "100%",
        /* containerCssClass: "select-sm", */
        allowClear: true,
        ajax: {
            url: base_url + $("#path").val() + "/get_customer_group",
            dataType: "json",
            delay: 250,
            data: function(params) {
                var query = {
