...
function get_data() {
    $.ajax({
        ...
        url: base_url + $("#path").val() + "/get_data_refference",
        dataType: "json",
        success: function(data) {
            if (data['data'] != null) {
                clear_tabel();
                ...
                $.each(data['data'], function(k, v) {
                    ...
                    cols += `<td><input type="number" autocomplete="off" class="form-control text-center form-control-sm" id="n_delivery${i}" value="${v['n_op']}" name="n_delivery[]"  onkeyup="change_ndisc(${i});hitung();raya(${i});" onblur=\"if(this.value==''){this.value='0';hitung();}\" onfocus=\"if(this.value=='0'){this.value='';}\"></td>`;
                    cols += `<td><input type="number" autocomplete="off" class="form-control text-center form-control-sm" id="bonus${i}" value="0" name="bonus[]"  onkeyup="" onblur=\"if(this.value==''){this.value='0';hitung();}\" onfocus=\"if(this.value=='0'){this.value='';}\">
                    </td>`;
                    ...
                    cols += `<td><input type="text" class="form-control text-right form-control-sm" id="e_remark${i}" name="e_remark[]" value="" ></td>`;
