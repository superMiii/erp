    ...
    var Detail = $(function() {
        ...
        $("#addrow").on("click", function() {
            ...
            if (no <= 20) {
                ...
                cols += `<td><input type="text" autocomplete="off" class="form-control text-right n_deliver form-control-sm" id="n_deliver${i}" value="0" name="n_deliver[]" onkeypress="return bilanganasli(event); cek(${i}); sama(${i});" onkeyup="cek(${i}); sama(${i}); " onblur=\"if(this.value==''){this.value='0';hitung();}\" onfocus=\"if(this.value=='0'){this.value='';}\"></td>`;
