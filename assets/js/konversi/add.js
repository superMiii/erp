    ...
    $("#i_product_asal").select2({
        ...
        $.ajax({
            ...
            success: function(data) {
                $("#i_product_motif_asal").val(data.detail[0]['i_product_motif']);
                $("#i_product_grade_asal").val(data.detail[0]['i_product_grade']);
                $("#e_product_motif").val(data.detail[0]['e_product_motifname']);
                $("#e_product_grade").val(data.detail[0]['e_product_gradename']);
                $("#e_product_name_asal").val(data.detail[0]['e_product_name']);
...
function raya() {
    ...
    if (qty > stok) {
        Swal.fire('Maaf Jumlah Konversi = ' + $('#n_convertion').val() + ' Melebihi Stock = ' + $('#n_stk').val());
        $('#n_convertion').val($('#n_stk').val());
    }
}