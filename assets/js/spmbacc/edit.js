...
var Detail = $(function() {
    ...
    $("#addrow").on("click", function() {
        ...
        cols += `<td><input type="number" value="0" readonly name="n_order[]" id="n_order${i}" class="form-control n_order form-control-sm" onkeypress="return bilanganasli(event);raya();" onkeyup="raya()" onblur=\"if(this.value==''){this.value='1';raya();}\" onfocus=\"if(this.value=='1'){this.value='';}\"></td>`;
        cols += `<td><input type="number" value="0" name="n_acc[]" id="n_acc${i}" class="form-control form-control-sm"onkeypress="return bilanganasli(event);raya();" onkeyup="raya()" onblur=\"if(this.value==''){this.value='1';raya();}\" onfocus=\"if(this.value=='1'){this.value='';}\"></td>`;
...
function raya() {
    ...
    var tot = 0;
    for (var x = 1; x <= jml; x++) {
        if ($('#n_acc' + x).length && $('#i_product' + x).val() != "") {
            v_price = $('#v_unit_price' + x).val().replaceAll(',', '');
            n_acc = $('#n_acc' + x).val().replaceAll(',', '');
            
            $('#n_acc' + x).val(n_acc);

            sub_total += v_price * n_acc;
