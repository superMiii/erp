...
class Salesbycategory extends CI_Controller
{
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('B' . $h, $this->lang->line('Kategori'))
            ->setCellValue('C' . $h, "OB")
            ->setCellValue('D' . $h, "OA")
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('B' . $i, $row->e_product_categoryname)
        ...
        $nama_file = "Performa Penjualan Berdasarkan Kategori " . " - " . $e_company_name . ".xls";
