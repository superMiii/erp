...
class Po extends CI_Controller
{
	...
	public function add()
	{
		...
		add_js(
			array(
				...
				'app-assets/vendors/js/pickers/pickadate/picker.js',
				'app-assets/vendors/js/pickers/pickadate/picker.date.js',
				'assets/js/' . $this->folder . '/list_spb.js?v=17',
			)
		);
		...
		$this->template->load('main', $this->folder . '/list_spb', $data);
	}
	...
	public function detail_pembelian()
	{
		...
		add_js(
			array(
				...
				'assets/js/' . $this->folder . '/pembelian.js?v=17',
			)
		);
		...
		$data = array(
			'data' 	 => $this->mymodel->get_data($id, $jenis)->row(),
			'dfrom'	 => $dfrom,
			'dto'	 => $dto,
		);
		$this->logger->write('Membuka Form Pembelian ' . $this->title);
		$this->template->load('main', $this->folder . '/pembelian', $data);
	}
	...
	public function get_supplier_price()
	{
		...
		if ($i_so != "") {
			$data['data'] = $this->mymodel->get_so_item($i_supplier, $i_so)->result();
		} else if ($i_sr != "") {
			$data['data'] = $this->mymodel->get_sr_item($i_supplier, $i_sr)->result();
		}
	...
	public function save()
	{
		...
		$this->form_validation->set_rules('d_document_submit', 'd_document_submit', 'trim|required|min_length[0]');
		$this->form_validation->set_rules('i_area', 'i_area', 'trim|required|min_length[0]');
		$this->form_validation->set_rules('jenis', 'jenis', 'trim|required|min_length[0]');
	...
	public function edit()
	{
		...
		add_js(
			array(
				...
				'app-assets/vendors/js/pickers/pickadate/picker.date.js',
				'app-assets/vendors/js/forms/toggle/bootstrap-checkbox.min.js',
				'assets/js/' . $this->folder . '/edit.js?v=1719',
			)
		);
	...
	public function get_data_detail()
	{
		...
		$data['data'] = $this->mymodel->get_po_item($id)->result();
	...
	public function view()
	{
		...
		add_js(
			array(
				...
				'app-assets/vendors/js/pickers/pickadate/picker.date.js',
				'app-assets/vendors/js/forms/toggle/bootstrap-checkbox.min.js',
				'assets/js/' . $this->folder . '/view.js?v=17',
			)
		);
