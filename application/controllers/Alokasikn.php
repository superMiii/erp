...
class Alokasikn extends CI_Controller
{
	public $id_menu = '51004';
	...
	public function delete2()
	{
		...
		$i_alokasi_id = $this->db->get_where('tm_alokasikn', ['i_company' => $this->i_company, 'i_alokasi'  => $id])->row()->i_alokasi_id;
		if ($this->form_validation->run() == false) {
			$data = array(
				'sukses' => false,
			);
