...
class Salesbyproduct extends CI_Controller
{
    public $id_menu = '70112';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('B' . $h, $this->lang->line('Kode'))
        ...
        $nama_file = "Performa Penjualan Berdasarkan Barang " . " - " . $e_company_name . ".xls";
