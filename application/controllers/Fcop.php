...
class Fcop extends CI_Controller
{
	public $id_menu = '603';
	...
	public function add()
	{
		...
		$this->logger->write('Membuka Form 	' . $this->title);
	...
	public function save()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			if ($this->db->trans_status() === FALSE) {
				...
				$this->logger->write('Membuat FC ' . $this->title . ' Tanggal : ' . $this->input->post('i_document') . ' : ' . $this->session->e_company_name);
				$data = array(
					'sukses' => true,
					'ada'	 => false,
				);
	...
	public function update()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			if ($this->db->trans_status() === FALSE) {
				...
				$this->db->trans_commit();
				$this->logger->write('Mengubah FC ' . $this->title . ' ID Forecast : ' . $this->input->post('id') . ' : ' . $this->session->e_company_name);
				$data = array(
					'sukses' => true,
					'ada'	 => false,
				);
	...
	public function delete()
	{
		...
		if ($this->form_validation->run() == false) {
			...
			if ($this->db->trans_status() === FALSE) {
				...
				$this->db->trans_commit();
				$this->logger->write('Cancel Data ' . $this->title . ' Id : ' . $id . ' : ' . $this->session->e_company_name);
				$data = array(
					'sukses' => true,
				);
			}
