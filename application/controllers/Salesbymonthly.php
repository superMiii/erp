...
class Salesbymonthly extends CI_Controller
{
    public $id_menu = '70109';
    ...
    public function index()
    {
        ...
        $data = array(
            'year'              => $year,
			'tahun' 			=> $year,
            'data'              => $this->mymodel->get_data($year),
        );
    ...
    public function export()
    {
        ...
        /** Query Get Data */
        $query      = $this->mymodel->get_data($year);
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('A3', "Periode : $prevth s/d $tahun")
        ...
        $nama_file = "Performa Penjualan Berdasarkan Bulanan " . " - " . $e_company_name . ".xls";
