...
class Infofakturbeli extends CI_Controller
{
    public $id_menu = '90206';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('B' . $h, $this->lang->line('No Dokumen'))
            ->setCellValue('C' . $h, $this->lang->line('Nota Pemasok'))
            ->setCellValue('D' . $h, $this->lang->line('Tgl Nota'))
            ->setCellValue('E' . $h, $this->lang->line('Nama Pemasok'))
            ->setCellValue('F' . $h, $this->lang->line('Jumlah Nota'))
            ->setCellValue('G' . $h, $this->lang->line('Sisa Nota'));
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('C' . $i, $row->i_nota_supplier)
                    ->setCellValue('D' . $i, Date::PHPToExcel($row->d_nota))
                    ->setCellValue('E' . $i, $row->e_supplier_name)
                    ->setCellValue('F' . $i, $row->v_nota_netto)
                    ->setCellValue('G' . $i, $row->v_sisa);
