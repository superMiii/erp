...
class Infospbcus extends CI_Controller
{
    public $id_menu = '90114';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('B' . $h, $this->lang->line('No Dok SPB'))
            ->setCellValue('C' . $h, $this->lang->line('Tgl Dok SPB'))
            ...
            ->setCellValue('H' . $h, $this->lang->line('Gudang'))
            ->setCellValue('I' . $h, $this->lang->line('Status SPB'))
            ->setCellValue('J' . $h, $this->lang->line('Jumlah SPB'))
            ->setCellValue('K' . $h, $this->lang->line('Referensi'));
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('I' . $i, $row->e_status_so_name)
                    ->setCellValue('J' . $i, $row->v_so)
                    ->setCellValue('K' . $i, $row->reff);
