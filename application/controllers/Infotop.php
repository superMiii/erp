...
class Infotop extends CI_Controller
{
    public $id_menu = '90120';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('D' . $h, $this->lang->line('Status Pelanggan'))
            ->setCellValue('E' . $h, $this->lang->line('Kelompok Harga'))
            ->setCellValue('F' . $h, $this->lang->line('TOP'))
            ->setCellValue('G' . $h, $this->lang->line('TOP Nota'))
            ->setCellValue('H' . $h, $this->lang->line('Plafon'));
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('D' . $i, $row->e_customer_statusname)
                    ->setCellValue('E' . $i, $row->e_price_groupname)
                    ->setCellValue('F' . $i, $row->n_customer_top)
                    ->setCellValue('G' . $i, $row->top30)
                    ->setCellValue('H' . $i, $row->pla);
