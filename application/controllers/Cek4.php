...
class Cek4 extends CI_Controller
{
    public $id_menu = '113';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('B' . $h, $this->lang->line('Nama Pramuniaga'))
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('B' . $i, $row->e_salesman_name)
                    ->setCellValue('C' . $i, $row->v_target)
                    ->setCellValue('D' . $i, $row->v_spb)
                    ->setCellValue('E' . $i, $row->v_nota)
                    ->setCellValue('F' . $i, $row->stat);
