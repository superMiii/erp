...
class Infoalokasikasmasuk extends CI_Controller
{
    public $id_menu = '90427';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('G' . $h, $this->lang->line('No. Recive Voucher'))
            ->setCellValue('H' . $h, $this->lang->line('Tgl Terima Voucher'))
            ->setCellValue('I' . $h, $this->lang->line('No Alokasi'))
            ->setCellValue('J' . $h, $this->lang->line('Tgl Alokasi'))
            ->setCellValue('K' . $h, $this->lang->line('Jumlah Terima Voucher'))
            ->setCellValue('L' . $h, $this->lang->line('Jumlah Alokasi'))
            ->setCellValue('M' . $h, $this->lang->line('Lebih'))
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('G' . $i, $row->i_rv_id)
                    ->setCellValue('H' . $i, Date::PHPToExcel($row->d_rv))
                    ->setCellValue('I' . $i, $row->i_alokasi_id)
                    ->setCellValue('J' . $i, Date::PHPToExcel($row->d_alokasi))
                    ->setCellValue('K' . $i, $row->jumlahbm)
                    ->setCellValue('L' . $i, $row->jumlahalokasi)
                    ->setCellValue('M' . $i, $row->v_lebih)
