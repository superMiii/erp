...
class Salesbybrand extends CI_Controller
{
    public $id_menu = '70110';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('B' . $h, $this->lang->line('Merk'))
            ->setCellValue('C' . $h, "OB")
            ->setCellValue('D' . $h, "OA")
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('B' . $i, $row->e_product_groupname)
        ...
        $nama_file = "Performa Penjualan Berdasarkan Merek " . " - " . $e_company_name . ".xls";
