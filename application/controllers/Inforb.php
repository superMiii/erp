...
class Inforb extends CI_Controller
{
    public $id_menu = '90209';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('C' . $h, $this->lang->line('No Dokumen'))
            ->setCellValue('D' . $h, $this->lang->line('Nama Pemasok'))
            ->setCellValue('E' . $h, $this->lang->line('Keterangan :'))
            ->setCellValue('F' . $h, $this->lang->line('Debet Nota'))
            ->setCellValue('G' . $h, $this->lang->line('Kode Barang'))
            ->setCellValue('H' . $h, $this->lang->line('Nama Barang'))
            ->setCellValue('I' . $h, $this->lang->line('Motif'))
            ->setCellValue('J' . $h, $this->lang->line('Harga'))
            ->setCellValue('K' . $h, $this->lang->line('Qty'));
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('B' . $i, $row->i_bbr_id)
                    ->setCellValue('C' . $i, $row->d_bbr)
                    ->setCellValue('D' . $i, $row->e_supplier_name)
                    ->setCellValue('E' . $i, $row->e_remark)
                    ->setCellValue('F' . $i, $row->f_dn)
