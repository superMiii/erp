...
class Infoexp extends CI_Controller
{
    public $id_menu = '90314';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('G' . $h, $this->lang->line('No DKB'))
            ->setCellValue('H' . $h, $this->lang->line('Tgl DKB'))
            ->setCellValue('I' . $h, $this->lang->line('Nama Ekspedisi'));
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('G' . $i, $row->i_sl_id)
                    ->setCellValue('H' . $i, Date::PHPToExcel($row->d_sl))
                    ->setCellValue('I' . $i, $row->e_sl_ekspedisi);
