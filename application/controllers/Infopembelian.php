...
class Infopembelian extends CI_Controller
{
    public $id_menu = '90201';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('B' . $h, $this->lang->line('Tgl Terima'))
            ->setCellValue('C' . $h, $this->lang->line('Kode Barang'))
            ->setCellValue('D' . $h, $this->lang->line('Nama Barang'))
            ->setCellValue('E' . $h, $this->lang->line('Qty'))
            ->setCellValue('F' . $h, $this->lang->line('Harga'))
            ->setCellValue('G' . $h, $this->lang->line('Diskon Rp'))
            ->setCellValue('H' . $h, $this->lang->line('Total'))
            ->setCellValue('I' . $h, $this->lang->line('Nama Pemasok'));
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('B' . $i, $row->d_gr)
                    ->setCellValue('C' . $i, $row->i_product_id)
                    ->setCellValue('D' . $i, $row->e_product_name)
                    ->setCellValue('E' . $i, $row->n_deliver)
                    ->setCellValue('F' . $i, $row->v_product_mill)
                    ->setCellValue('G' . $i, $row->v_gr_discount)
                    ->setCellValue('H' . $i, $row->v_gr)
                    ->setCellValue('I' . $i, $row->e_supplier_name);
