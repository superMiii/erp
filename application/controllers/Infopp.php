...
class Infopp extends CI_Controller
{
    public $id_menu = '90121';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('B' . $h, $this->lang->line('Tgl SPB'))
            ->setCellValue('C' . $h, $this->lang->line('No Dok SPB'))
