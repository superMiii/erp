...
class Alokasimt extends CI_Controller
{
	public $id_menu = '51002';
	...
	public function delete2()
	{
		...
		$i_alokasi_id = $this->db->get_where('tm_alokasimt', ['i_company' => $this->i_company, 'i_alokasimt'  => $id])->row()->i_alokasimt_id;
		if ($this->form_validation->run() == false) {
			$data = array(
				'sukses' => false,
			);
