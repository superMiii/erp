...
class Alokasibk extends CI_Controller
{
	public $id_menu = '51201';
	...
	public function delete2()
	{
		...
		$i_alokasi_id = $this->db->get_where('tm_alokasi_bk', ['i_company' => $this->i_company, 'i_alokasi'  => $id])->row()->i_alokasi_id;
		if ($this->form_validation->run() == false) {
			$data = array(
				'sukses' => false,
			);
