...
class Infokum extends CI_Controller
{
    public $id_menu = '90415';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('A3', "Pelanggan : $e_salesman_name")
            ->setCellValue('A4', "Periode : $dfrom s/d $dto")
            ->setCellValue('A' . $h, $this->lang->line('No'))
            ->setCellValue('B' . $h, $this->lang->line('No. KUM'))
            ->setCellValue('C' . $h, $this->lang->line('Tgl. KUM'))
            ...
            ->setCellValue('G' . $h, $this->lang->line('Nama Pramuniaga'))
            ->setCellValue('H' . $h, $this->lang->line('Nama Bank'))
            ->setCellValue('I' . $h, $this->lang->line('Atas Nama Pengirim'))
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('B' . $i, $row->i_kum_id)
                    ->setCellValue('C' . $i, Date::PHPToExcel($row->d_kum))
                    ...
                    ->setCellValue('H' . $i, $row->e_bank_name)
                    ->setCellValue('I' . $i, $row->e_atasnama)
                    ->setCellValue('J' . $i, $row->v_jumlah);
