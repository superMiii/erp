...
class Infospmb2 extends CI_Controller
{
    public $id_menu = '90308';
    ...
    public function view()
    {
        ...
        $i_sr         = decrypt_url($this->uri->segment(3));
        ...
        $i_sr_id = $this->db->get_where('tm_sr', ['i_sr' => $i_sr])->row()->i_sr_id;
        $data = array(
            'detail'            => $this->mymodel->get_data_detail($i_sr, $i_company, $dfrom, $dto, $i_area),
            'dfrom'                => $dfrom,
            'dto'                => $dto,
            'i_area'           => $i_area,
            'e_area_name'      => ucwords(strtolower($e_area_name)),
