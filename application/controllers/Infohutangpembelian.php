...
class Infohutangpembelian extends CI_Controller
{
    public $id_menu = '90210';
    ...
    public function export()
    {
        ...
        $spreadsheet->setActiveSheetIndex(0)
            ...
            ->setCellValue('A2', "Periode Akhir : $dto")
            ->setCellValue('A3', "Supplier : $e_supplier_name")
            ->setCellValue('A' . $h, $this->lang->line('No'))
            ->setCellValue('B' . $h, $this->lang->line('Nota Pembelian'))
            ->setCellValue('C' . $h, $this->lang->line('Nama Pemasok'))
            ->setCellValue('D' . $h, $this->lang->line('TOP'))
            ->setCellValue('E' . $h, $this->lang->line('Tgl Nota Pembelian'))
            ->setCellValue('F' . $h, $this->lang->line('Tgl Jatuh Tempo'))
            ->setCellValue('G' . $h, $this->lang->line('Jumlah Nota'))
            ->setCellValue('H' . $h, $this->lang->line('Sisa Nota'));
        ...
        if ($query->num_rows() > 0) {
            ...
            foreach ($query->result() as $row) {
                $spreadsheet->setActiveSheetIndex(0)
                    ...
                    ->setCellValue('C' . $i, $row->e_supplier_name)
                    ->setCellValue('D' . $i, $row->n_supplier_top)
                    ->setCellValue('E' . $i, $row->d_nota)
                    ->setCellValue('F' . $i, $row->d_jatuh_tempo)
                    ->setCellValue('G' . $i, $row->kn)
                    ->setCellValue('H' . $i, $row->yr);
