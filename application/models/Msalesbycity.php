...
class Msalesbycity extends CI_Model
{
    ...
    public function serverside()
    {
          ...
          if ($pro == '2') {
              $epro = "AND ru.e_area_island ILIKE '%PULAU BALI%'";
          } elseif ($pro == '$this->i_company') {
              $epro = "AND ru.e_area_island ILIKE '%PULAU JAWA%'";
          } elseif ($pro == '4') {
              $epro = "AND ru.e_area_island ILIKE '%PULAU KALIMANTAN%'";
          } elseif ($pro == '5') {
              $epro = "AND ru.e_area_island ILIKE '%PULAU NUSA TENGGARA%'";
          } elseif ($pro == '6') {
              $epro = "AND ru.e_area_island ILIKE '%PULAU PAPUA%'";
          } elseif ($pro == '7') {
              $epro = "AND ru.e_area_island ILIKE '%PULAU SULAWESI%'";
          } elseif ($pro == '8') {
              $epro = "AND ru.e_area_island ILIKE '%PULAU SUMATERA%'";
          } else {
              $epro = "";
          }
          ...
          $datatables->query("SELECT
                         ru.i_area as id,
                         ru.e_area_island,
                         ru.i_area_id || ' - ' || ru.e_area_name as araa,
                         mi.e_city_name ,
                         io.ob,
                         miu.oa,
                         miu.oaa,
                    ...
                    inner join (
                         ...
                         (miu.i_city = io.i_city)
                    inner join tr_city mi on
                         (mi.i_city = miu.i_city)
                    inner join tr_area ru on
                         (mi.i_area = ru.i_area)
                    where 
                         miu.i_company = '$this->i_company'
                         $epro
                         $area
                    order by ru.i_area, mi.e_city_name 
                              ", FALSE);
    ...
    /** Get Data Untuk Edit */
    public function get_data($dfrom, $dto, $pro, $i_area)
    {
