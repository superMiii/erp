...
class Minfoalokasikasmasuk extends CI_Model
{
    ...
    public function serverside()
    {
        ...
        $datatables->query("SELECT
            ...
            from
                tm_nota a 
                inner join tm_alokasi_kas_item b on (b.i_nota=a.i_nota)
                inner join tm_alokasi_kas c on (c.i_alokasi=b.i_alokasi)
