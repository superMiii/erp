...
class Mspbapprovesales extends CI_Model
{
    ...
    public function serverside()
    {
        ...
        $datatables->query("SELECT
            ...
            WHERE
                ...
                AND
                    CASE
                        WHEN f_so_stockdaerah = 'f' THEN a.d_approve1 ISNULL
                        AND a.d_approve2 ISNULL
                        ELSE a.d_approve1 ISNULL
    ...
    public function approve($id, $note)
    {
        ...
        $this->db->query("UPDATE
                tm_so
            SET
                i_approve1 = '$e_user_name',
                d_approve1 = current_date,
                e_approve1 = '$note',
                i_status_so = CASE
                    WHEN f_so_stockdaerah = 'f' AND d_approve2 ISNULL THEN 2
                    WHEN f_so_stockdaerah = 't' AND d_approve2 NOTNULL THEN 3
                    ELSE i_status_so 
                END
            WHERE
                i_so = '$id'
