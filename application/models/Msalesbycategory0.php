...
class Msalesbycategory extends CI_Model
{
            ...
            FROM
                ...
                FROM
                    ...
                    FROM
                        (
                        SELECT
                            c.i_product_category,
                            c.e_product_categoryname,
                ...
                UNION ALL
                    ...
                    FROM
                        ...
                        SELECT
                            ...
                            e.e_product_categoryname,
                            e.i_product_category
                        FROM
                            tm_nota a,
                            tm_nota_item b,
                            tr_customer c,
                            tr_product d,
                            tr_product_category e,
                            tr_customer f
                        WHERE
