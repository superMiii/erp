...
class Msalesbycategory extends CI_Model
{
    ...
    public function serverside()
    {
          ...
          $datatables->query("SELECT 
                        miu.i_product_category,
                        yua.e_product_categoryname ,
                        io.ob,
                        miu.oa,
                        miu.oaa,
                        case
                            ...
                            from
                                ...
                                from
                                    ...
                                    from
                                        ...
                                        inner join tr_product_category ff on
                                            (ff.i_product_category = ee.i_product_category)
                                        where
                    ...
                    inner join tr_product_category yua on
                        (miu.i_product_category = yua.i_product_category)
                    order by 1
                         ", FALSE);
