                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control round text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line("Kode Kategori"); ?>" id="i_product_categoryid" name="i_product_categoryid" maxlength="100" autocomplete="off" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label><?= $this->lang->line("Nama Kategori"); ?> :</label>
                                    <div class="controls">
                                        <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line("Nama Kategori"); ?>" id="e_product_categoryname" name="e_product_categoryname" maxlength="500" autocomplete="off" required>
                                    </div>
                                </div>
