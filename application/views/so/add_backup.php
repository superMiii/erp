                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                <input type="text" class="form-control form-control-sm date" readonly data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                <input id="d_po" name="d_po" type='text' readonly class="form-control form-control-sm date" placeholder="<?= $this->lang->line('Tanggal PO'); ?>" />
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <span class="fa fa-calendar-o"></span>
                                                    </span>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            <thead class="<?= $this->session->e_color;?> bg-darken-1 text-white">
                                                <tr>
                                                    ...
                                                    <th rowspan="2" class="text-center" width="10%" valign="center"><?= $this->lang->line("Harga"); ?></th>
                                                    ...
                                                    <th rowspan="1" class="text-center" colspan="2" width="14%"><?= $this->lang->line("Diskon2"); ?></th>
                                                    <th rowspan="1" class="text-center" colspan="2" width="14%"><?= $this->lang->line("Diskon3"); ?></th>
                                                    <th rowspan="2 " class="text-center" width="14%" valign="center"><?= $this->lang->line("Total"); ?></th>
                                                    <th rowspan="2" class="text-center" width="3%"><i class="fa fa-plus-circle fa-lg" title="<?= $this->lang->line('Tambah'); ?>" id="addrow"></i></th>
                                                </tr>
                                                <tr>
