                                ...
                                <div class="table-responsive">
                                    <table class="table table-xs table-column table-bordered" id="tabledetail">
                                                ...
                                                foreach ($detail->result() as $key) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            <input type="hidden" value="<?= $key->v_so_discount1; ?>" class="form-control text-right form-control-sm" id="v_disc<?= $i; ?>" name="v_disc[]" readonly>
                                                        ...
                                                        <td><input type="text" value="<?= $key->n_so_discount1; ?>" class="form-control text-right form-control-sm" id="n_disc<?= $i; ?>" name="n_disc[]" readonly></td>
                                        ...
                                        <tfoot>
                                            ...
                                            <tr>
                                                <th colspan="7" class="text-right"><?= $this->lang->line("PPN"); ?> (<?= $data->n_so_ppn; ?>%) Rp. </th>
