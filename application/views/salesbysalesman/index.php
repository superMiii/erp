                                    ...
                                    <div class="form-group row m-auto">
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-2">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_salesman" id="i_salesman" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Area"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right"><strong>Rp. <?= number_format($v1, 0); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($v2, 0); ?></strong></th>
                                            <th class="text-right"></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($v3, 0); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($v4, 0); ?></strong></th>
                                            <th class="text-right"></th>
