                    ...
                    <div class="card-body area-print">
                        ...
                        <div class="invoice-logo-title row">
                            <div class="col-9 d-flex flex-column justify-content-center align-items-start">
                                ...
                                <p class="font-large-2 text-uppercase text-primary">RETUR PEMBELIAN
                                    <input type="hidden" id="id" value="<?= $data->i_bbr; ?>">
                                    <input type="hidden" id="path" value="<?= base_url($this->folder); ?>">
                                    <br><span class="font-medium-3 font-weight-bold">Nomor SPB : <?= $data->i_bbr_id; ?></span>
                                    <br><span class="font-medium-3 font-weight-bold">Tanggal SPB : <?= date('d', strtotime($data->d_bbr)) . ' ' . bulan(date('m', strtotime($data->d_bbr))) . ' ' . date('Y', strtotime($data->d_bbr)); ?></span>
                                </p>
                            </div>
