                ...
                <div class="col-12">
                    <div class="card box-shadow-0 border-primary">
                        <div class="card-header card-head-inverse <?= $this->session->e_color; ?> bg-darken-1 text-white">
                            <h4 class="card-title"><i class="icon-plus"></i> <?= $this->lang->line('lihat'); ?> <?= $this->lang->line($this->title); ?></h4>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <fieldset>
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="hidden" name="id" id="id" readonly value="<?= $data->i_dn; ?>">
                                                        <input type="hidden" name="i_document_old" id="i_document_old" readonly value="<?= $data->i_dn_id; ?>">
                                                        <input type="text" name="i_document" id="i_document" readonly value="<?= $data->i_dn_id; ?>" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm date" readonly min="<?= get_min30(); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_dn; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <fieldset>
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="hidden" readonly name="i_refference" value="<?= $data->i_bbr; ?>">
                                                        <input type="text" readonly name="i_refference_bbm" id="i_refference" value="<?= $data->i_bbr_id; ?>" placeholder="000001" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="text" readonly class="form-control form-control-sm date" value="<?= $data->d_bbr; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_refference" name="d_refference" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="row">
                                        <div class="col-sm-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="hidden" id="i_supplier" name="i_supplier" value="<?= $data->i_supplier; ?>">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="controls">
                                                    <fieldset>
                                                        <div class="float-left">
                                                            <input readonly type="checkbox" <?php if ($data->f_masalah == 't') {
                                                                                        echo "checked";
                                                                                    } ?> id="f_masalah" name="f_masalah" class="switch" data-group-cls="btn-group-sm" data-on-label="<?= $this->lang->line('Ya'); ?>" data-off-label="<?= $this->lang->line('Tidak'); ?>" data-switch-always />
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <fieldset>
                                                        <div class="float-left">
                                                            <input readonly type="checkbox" <?php if ($data->f_insentif == 't') {
                                                                                        echo "checked";
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea required readonly class="form-control text-capitalize" placeholder="<?= $this->lang->line('Keterangan'); ?>" id="e_remark" name="e_remark"><?=  $data->e_remark; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-body">
                                    <div class="table-responsive">
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <td class="text-center" valign="center">
                                                            ...
                                                            <td><input type="text" readonly name="i_product[]" id="i_product<?= $i; ?>" class="form-control form-control-sm" value="<?= $key->i_product_id . ' - ' . $key->e_product_name; ?>">  </td>
                                                            <td><input type="text" readonly autocomplete="off" class="form-control text-right v_unit_price form-control-sm" id="v_unit_price<?= $i; ?>" name="v_unit_price[]" value="<?= number_format($key->v_unit_price); ?>"  onkeypress="return bilanganasli(event);hetang();" onkeyup="hetang();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                            <td><input type="number" readonly autocomplete="off" class="form-control text-right n_order form-control-sm" id="n_order<?= $i; ?>" value="<?= $key->n_quantity; ?>" name="n_order[]" onkeypress="return bilanganasli(event);hetang();" onkeyup="hetang();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                            ...
                                                            <input type="text" readonly class="form-control form-control-sm" id="ket<?= $i; ?>" name="ket[]" value="<?= $key->ket; ?>">
                                                            </td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            ...
                                            <tfoot>
                                            <tr hidden>
                                                    <th colspan="4" class="text-right"><?= $this->lang->line("Sub Total"); ?></th>
                                                ...
                                                <tr hidden>
                                                    <th colspan="4" class="text-right"><?= $this->lang->line("Diskon"); ?></th>
                                                ...
                                                <tr hidden>
                                                    <th colspan="4" class="text-right"><?= $this->lang->line("Diskon Rp"); ?></th>
