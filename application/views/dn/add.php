                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?= base_url($this->folder . '/indexx/' . encrypt_url($dfrom) . '/' . encrypt_url($dto) . '/' . encrypt_url($i_supplier)); ?>" class="btn btn-secondary round btn-min-width mr-1"><i class="icon-action-undo mr-1"></i><?= $this->lang->line("Kembali"); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
