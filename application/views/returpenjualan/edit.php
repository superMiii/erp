                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" class="form-control form-control-sm date" readonly min="<?= date('Y-m-01'); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_ttb; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <textarea required class="form-control text-capitalize" placeholder="<?= $this->lang->line('Keterangan'); ?>" id="e_remark" name="e_remark"><?= $data->e_ttb_remark; ?></textarea>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" class="form-control text-right form-control-sm" id="i_nota_id<?= $i; ?>" name="i_nota_id[]" value="<?= $key->i_nota_id; ?>" readonly></td>
                                                            ...
                                                            <td><input type="number" autocomplete="off" class="form-control text-center n_quantity form-control-sm" id="n_quantity<?= $i; ?>" value="<?= $key->n_quantity; ?>" name="n_quantity[]" onkeyup=" cek(<?= $i; ?>);hetang(); hetangdiskonrp(); hetangdiskon();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                            ...
                                                            <td><input type="text" class="form-control form-control-sm" name="e_ttb_remark[]" value="<?= $key->e_ttb_remark; ?>"></td>
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    ...
                                                    <th><input type="text" autocomplete="off" class="formatrupiah form-control form-control-sm text-right tfoot" value="<?= number_format($data->v_ttb_discounttotal); ?>" onkeyup="formatrupiahkeyup(this);hetangdiskonrp();" onkeydown="formatrupiahkeydown(this);hetangdiskonrp();" onblur="if(this.value==''){this.value='0';hetang();}" onfocus="if(this.value=='0'){this.value='';}" id="v_ttb_discounttotal" name="v_ttb_discounttotal"></th>
                                                    <th colspan="2"></th>
                                                </tr> -->
                                                <input type="hidden" autocomplete="off" class="formatrupiah form-control form-control-sm hidden-right tfoot" value="0" onkeyup="formatrupiahkeyup(this);hetangdiskon();" onkeydown="formatrupiahkeydown(this);hetangdiskon();" onblur="if(this.value==''){this.value='0';hetang();}" onfocus="if(this.value=='0'){this.value='';}" id="n_ttb_discounttotal" name="n_ttb_discounttotal">
                                                <input type="hidden" autocomplete="off" class="formatrupiah form-control form-control-sm text-right tfoot" value="<?= number_format($data->v_ttb_discounttotal); ?>" onkeyup="formatrupiahkeyup(this);hetangdiskonrp();" onkeydown="formatrupiahkeydown(this);hetangdiskonrp();" onblur="if(this.value==''){this.value='0';hetang();}" onfocus="if(this.value=='0'){this.value='';}" id="v_ttb_discounttotal" name="v_ttb_discounttotal">
                                                <tr>
                                                ...
                                                <?php if ($this->session->f_company_plusppn == 't') { ?>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><input type="text" autocomplete="off" class="formatrupiah form-control form-control-sm font-weight-bold tfoot" value="<?= number_format($data->n_ppn_r); ?>" onkeyup="formatrupiahkeyup(this);hetangdiskon();" onkeydown="formatrupiahkeydown(this);hetangdiskon();" onblur="if(this.value==''){this.value='0';hetang();}" onfocus="if(this.value=='0'){this.value='';}" id="n_ppn" name="n_ppn"></th>
                                                        <th colspan="2"></th>
                                                    </tr>
