                    ...
                    <div class="card-body area-print">
                        ...
                        <div class="invoice-logo-title row">
                            <div class="col-9 d-flex flex-column justify-content-center align-items-start">
                                ...
                                <p class="font-large-2 text-uppercase text-primary"><?= $this->lang->line('Retur Penjualan'); ?>
                                    <input type="hidden" id="id" value="<?= $data->i_ttb; ?>">
                                    <input type="hidden" id="path" value="<?= base_url($this->folder); ?>">
                                    <br><span class="font-medium-3 font-weight-bold">Nomor TTB : <?= $data->i_ttb_id; ?></span>
                                    <br><span class="font-medium-3 font-weight-bold">Tanggal TTB : <?= date('d', strtotime($data->d_ttb)) . ' ' . bulan(date('m', strtotime($data->d_ttb))) . ' ' . date('Y', strtotime($data->d_ttb)); ?></span>
                                </p>
                            </div>
                        ...
                        <div class="product-details-table table-responsive">
                            <div class="table-responsive">
                                <table class="table table-xs table-bordered mt-0 mb-0">
                                    ...
                                    <tfoot>
                                        <tr>
                                            <td colspan="4">Tanggal Daftar : <?= date('d', strtotime($data->d_customer_register)) . ' ' . bulan(date('m', strtotime($data->d_customer_register))) . ' ' . date('Y', strtotime($data->d_customer_register)); ?></td>
                                            <th class="text-right" colspan="5"><?= $this->lang->line('Sub Total'); ?> Rp. </th>
