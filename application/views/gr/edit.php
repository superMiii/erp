                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" class="form-control form-control-sm" min="<?= get_min30(); ?>" max="<?= date('Y-m-d'); ?>" value="<?= date('Y-m-d', strtotime($data->d_gr)); ?>" <?= koncix(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input id="d_po" name="d_po" type='date' value="<?= date('Y-m-d', strtotime($data->d_po)); ?>" <?= konci(); ?> class="form-control form-control-sm" placeholder="<?= $this->lang->line('Tanggal PO'); ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" class="form-control form-control-sm" value="<?= date('Y-m-d', strtotime($data->d_estimation)); ?>" <?= konci(); ?> placeholder="" id="d_estimation" name="d_estimation" maxlength="500" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control form-control-sm" placeholder="" id="i_refference" name="i_refference" maxlength="500" autocomplete="off" value="<?= $data->i_refference; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr hidden>
                                                    ...
                                                    <th><input type="text" class="formatrupiah form-control form-control-sm text-right" value="<?= number_format($data->v_gr_discount, 2); ?>" onkeyup="formatrupiahkeyup(this);change_vdisc_foot();hitung();" onkeydown="formatrupiahkeydown(this);change_vdisc_foot();hitung();" onblur="if(this.value==''){this.value='0';hitung();}" onfocus="if(this.value=='0'){this.value='';}" id="tfoot_v_diskon" name="tfoot_v_diskon"></th>
                                                </tr>
                                                <tr hidden>
