                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly name="i_document" id="i_document" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox" value="<?= $data->i_gr_id; ?>">
                                                <input type="hidden" name="id" id="id" class="form-control" value="<?= $data->i_gr; ?>">
                                                <input type="hidden" name="i_document_old" id="i_document_old" class="form-control" value="<?= $data->i_gr_id; ?>">
                                            </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                <input type="text" class="form-control form-control-sm" readonly data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" value="<?= $data->d_gr; ?>" maxlength="500" autocomplete="off" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                <input id="d_po" name="d_po" type='text' value="<?= $data->d_po; ?>" readonly class="form-control form-control-sm" placeholder="<?= $this->lang->line('Tanggal PO'); ?>" />
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <span class="fa fa-calendar-o"></span>
                                                    </span>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control form-control-sm" placeholder="" id="i_refference" name="i_refference" maxlength="500" autocomplete="off" readonly value="<?= $data->i_refference; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            ...
                                            <tfoot>
                                                ...
                                                <tr hidden>
                                                    ...
                                                    <th><input type="text" class="formatrupiah form-control form-control-sm text-right" value="0" readonly onkeyup="formatrupiahkeyup(this);change_ndisc_foot();hitung();" onkeydown="formatrupiahkeydown(this);change_ndisc_foot();hitung();" onblur="if(this.value==''){this.value='0';hitung();}" onfocus="if(this.value=='0'){this.value='';}" id="tfoot_n_diskon" name="tfoot_n_diskon"></th>
                                                </tr>

                                                <tr hidden>
                                                    <th colspan="9" class="text-right"><?= $this->lang->line("Diskon Rp"); ?></th>
                                                    <th><input type="text" class="formatrupiah form-control form-control-sm text-right" readonly value="<?= number_format($data->v_gr_discount, 2); ?>" onkeyup="formatrupiahkeyup(this);change_vdisc_foot();hitung();" onkeydown="formatrupiahkeydown(this);change_vdisc_foot();hitung();" onblur="if(this.value==''){this.value='0';hitung();}" onfocus="if(this.value=='0'){this.value='';}" id="tfoot_v_diskon" name="tfoot_v_diskon"></th>
                                                </tr>
                                                <tr hidden>
