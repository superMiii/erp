                            ...
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="hidden" class="form-control" id="epowerold" name="epowerold" value="<?= $data->e_power_name; ?>">
                                        <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line('Required'); ?>" value='<?= $data->e_power_name; ?>' placeholder="<?= $this->lang->line("Masukan") . ' ' . $this->lang->line("Power"); ?>" id="epower" name="epower" maxlength="30" autocomplete="off" required autofocus>
                                    </div>
                                </div>
