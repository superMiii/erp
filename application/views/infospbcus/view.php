                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <h5 class="text-center text-bold-600 mb-0">No. SPB : <?= $i_so_id; ?></h5>
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside2" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Jumlah Pesan'); ?></th>
                                            <th><?= $this->lang->line('Jumlah Kirim'); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td class="text-right">Rp. <?= number_format($key->v_unit_price); ?></td>
                                                </tr>
                                        <?php }
                                        } ?>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-right">Rp. <?= number_format($tt); ?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
