                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Kode Departemen'); ?>" id="kode" name="kode" maxlength="30" autocomplete="off" required autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Nama Departemen'); ?>" id="nama" name="nama" maxlength="100" autocomplete="off" required autofocus>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <textarea class="form-control round" placeholder="<?= $this->lang->line('Keterangan'); ?> .." name="deskripsi"></textarea>
                                </div>
