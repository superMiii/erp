                                    ...
                                    <div class="form-group row m-auto">
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_customer" id="i_customer" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Area"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Jenis Pembayaran'); ?></th>
                                            <th><?= $this->lang->line('Transfer'); ?></th>
                                            <th><?= $this->lang->line('Tunai'); ?></th>
                                            <th><?= $this->lang->line('Giro'); ?></th>
                                            <th><?= $this->lang->line('No. Recive Voucher'); ?></th>
                                            <th><?= $this->lang->line('Tgl Terima Voucher'); ?></th>
                                            <th><?= $this->lang->line('No Alokasi'); ?></th>
                                            <th><?= $this->lang->line('Tgl Alokasi'); ?></th>
                                            <th><?= $this->lang->line('Jumlah Terima Voucher'); ?></th>
                                            <th><?= $this->lang->line('Jumlah Alokasi'); ?></th>
                                            <th><?= $this->lang->line('Lebih'); ?></th>
                                            <th><?= $this->lang->line('Jumlah Nota'); ?></th>
                                            <th><?= $this->lang->line('Sisa Nota'); ?></th>
                                            <th><?= $this->lang->line('Keterangan :'); ?></th>
                                            <th><?= $this->lang->line('No. DT'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                </table>
