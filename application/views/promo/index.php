                                    ...
                                    <div class="form-group row m-auto">
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_promo_type" id="i_promo_type" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Promo"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                            <option value="<?= $i_promo_type; ?>"><?= $e_promo_type_name; ?></option>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            <th>No</th>
                                            <th><?= $this->lang->line('Tanggal Promo'); ?></th>
                                            <th><?= $this->lang->line('Kode Promo'); ?></th>
                                            <th><?= $this->lang->line('Nama Promo'); ?></th>
                                            <th><?= $this->lang->line('Tipe Promo'); ?></th>
                                            <th><?= $this->lang->line('Berlaku Dari'); ?></th>
                                            <th><?= $this->lang->line('Berlaku Sampai'); ?></th>
