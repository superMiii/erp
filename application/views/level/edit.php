                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    <label><?= $this->lang->line('Nama Level'); ?> :</label>
                                    <div class="controls">
                                        <input type="hidden" class="form-control" id="ilevel" name="ilevel" value="<?= $data->i_level; ?>">
                                        <input type="hidden" class="form-control" id="elevelold" name="elevelold" value="<?= $data->e_level_name; ?>">
                                        <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line('Required'); ?>" value='<?= $data->e_level_name; ?>' placeholder="<?= $this->lang->line("Masukan") . ' ' . $this->lang->line("Level"); ?>" id="elevel" name="elevel" maxlength="30" autocomplete="off" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label><?= $this->lang->line('Deskripsi'); ?> :</label>
                                    <textarea class="form-control round" placeholder="<?= $this->lang->line('Deskripsi'); ?> .." name="deskripsi"><?= $data->e_deskripsi; ?></textarea>
                                </div>
