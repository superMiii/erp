                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line("Masukan") . ' ' . $this->lang->line("Level"); ?>" id="elevel" name="elevel" maxlength="30" autocomplete="off" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label><?= $this->lang->line('Deskripsi'); ?> :</label>
                                    <textarea class="form-control round" placeholder="<?= $this->lang->line('Deskripsi'); ?> .." name="deskripsi"></textarea>
                                </div>
