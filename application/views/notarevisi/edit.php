                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="hidden" name="i_nota" id="i_nota" class="form-control" value="<?= $i_nota; ?>">
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                                <tr>
                                                    ...
                                                    <th valign="center"><?= $this->lang->line("Motif"); ?></th>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" value="<?= $key->n_do; ?>" autocomplete="off" class="form-control text-right n_order form-control-sm" id="n_deliver<?= $i; ?>" name="n_deliver[]" onkeypress="return bilanganasli(event);cek(<?= $i; ?>);" onkeyup="cek(<?= $i; ?>)" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}">
