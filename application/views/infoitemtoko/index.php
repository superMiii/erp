                                    ...
                                    <div class="form-group row m-auto">
                                        ...
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-5">
                                                ...
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_product" id="i_product" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Pelanggan"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('HARGA JUAL'); ?></th>
