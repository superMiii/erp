                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input readonly id="d_berangkat" name="d_berangkat" type='date' value="<?= $data->d_berangkat; ?>" class="form-control" value="<?= date('Y-m-d'); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line('Tanggal Berangkat'); ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" readonly class="form-control round text-capitalize" value="<?= $data->e_dn_atasan_name; ?>" id="i_dn_atasan" name="i_dn_atasan"  autocomplete="off">
                                            </div>
                                        </div>
                                    </div>                                 
                                    <div class="col-md-4">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <label><?= $this->lang->line("Keterangan Menyetujui / Tidak Menyetujui"); ?> :</label>
                                            <div class="controls">
                                                <input type="text" class="form-control round text-capitalize" placeholder="<?= $this->lang->line('Alasan Setuju / Tidak Setuju'); ?>" id="e_note" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <button type="button" onclick="app('<?= $this->folder; ?>','<?= $data->i_dinas; ?>','<?= encrypt_url($dfrom); ?>','<?= encrypt_url($dto); ?>','<?= encrypt_url($hstore); ?>');" class="btn btn-info round btn-min-width mr-1"><i class="fa fa-check-circle fa-lg mr-1"></i><?= $this->lang->line("Menyetujui"); ?></button>
                                    <button type="button" onclick="notapp('<?= $this->folder; ?>','<?= $data->i_dinas; ?>','<?= encrypt_url($dfrom); ?>','<?= encrypt_url($dto); ?>','<?= encrypt_url($hstore); ?>');" class="btn btn-danger round btn-min-width mr-1"><i class="fa fa-times-circle-o fa-lg mr-1"></i><?= $this->lang->line("Tidak Menyetujui"); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
