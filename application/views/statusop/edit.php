                            ...
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="hidden" class="form-control" id="i_status_op" name="i_status_op" value="<?= $data->i_status_op; ?>">
                                        <input type="hidden" class="form-control" id="i_status_op_id_old" name="i_status_op_id_old" value="<?= $data->i_status_op_id; ?>">
                                        <input type="text" class="form-control round text-uppercase" value="<?= $data->i_status_op_id; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line("Kode Status Pemesanan"); ?>" id="i_status_op_id" name="i_status_op_id" maxlength="100" autocomplete="off" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label><?= $this->lang->line("Nama Status Pemesanan"); ?> :</label>
                                    <div class="controls">
                                        <input type="text" class="form-control round text-capitalize" value="<?= $data->e_status_op_name; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line("Nama Status Pemesanan"); ?>" id="e_status_op_name" name="e_status_op_name" maxlength="500" autocomplete="off" required>
                                    </div>
                                </div>
