                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control round text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line("Kode Kelompok"); ?>" id="i_product_statusid" name="i_product_statusid" maxlength="100" autocomplete="off" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label><?= $this->lang->line("Nama Status"); ?> :</label>
                                    <div class="controls">
                                        <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line("Nama Status"); ?>" id="e_product_statusname" name="e_product_statusname" maxlength="500" autocomplete="off" required>
                                    </div>
                                </div>
