                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" <?= koncix(); ?> class="form-control form-control-sm date" min="<?= get_min_date2(); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_tunai; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    ...
                                                    <!-- <select class="form-control" name="i_dt" id="i_dt" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Daftar Tagihan"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>"> -->
                                                    <select class="form-control" id="i_dt" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Daftar Tagihan"); ?>" name="i_dt">
        ...
        <section id="pagination">
            <div class="row">
                <div class="col-12">
                    <div class="card box-shadow-0 border-primary">
                        <div class="card-header card-head-inverse <?= $this->session->e_color; ?> bg-darken-1 text-white">
                            <h4 class="card-title"><i class="fa fa-cart-arrow-down"></i> <?= $this->lang->line("Detail"); ?> <?= $this->lang->line("Tunai"); ?></h4>
                            <a class="heading-elements-toggle"><i class="fa fa-ellipsis-v font-medium-3"></i></a>
                            <div class="heading-elements">
                                <ul class="list-inline mb-0">
                                    <li><a data-action="collapse"><i class="feather icon-minus"></i></a></li>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center" width="20%" valign="center"><?= $this->lang->line("Jumlah Nota"); ?></th>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" value="<?= number_format($key->v_nota_netto); ?>" readonly class="form-control form-control-sm text-right" id="v_jumlah_item2<?= $i; ?>" name="v_jumlah_item2[]" readonly></td>
                                                            <td><input type="text" class="form-control form-control-sm text-right v_jumlah" value="<?= number_format($key->v_jumlah); ?>" id="v_jumlah_item<?= $i; ?>" name="v_jumlah_item[]" onkeypress="return bilanganasli(event);hetang();" onkeyup="reformat(this);hetang();" onblur="if(this.value==''){this.value='0';hetang();}" onfocus="if(this.value=='0'){this.value='';}"></td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th><input type="text" class="form-control form-control-sm text-right" name="v_jumlah" id="v_jumlah" value="<?= number_format($data->v_jumlah); ?>" readonly></th>
                                                </tr>
                                            </tfoot>
