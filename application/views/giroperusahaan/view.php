                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" readonly class="form-control form-control-sm date" min="2021-10-01" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_giro_kirim; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_giro_terima" name="d_giro_terima" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly class="form-control form-control-sm" value="<?= $data->i_supplier_id . ' - ' . $data->e_supplier_name; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
