                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Realisasi Biaya'); ?></th>
                                            <th><?= $this->lang->line('Realisasi SPB'); ?></th>
                                    ...
                                    <tfoot>
                                        ...
                                        if ($data->num_rows() > 0) {
                                            foreach ($data->result() as $key) {
                                                $m       += $key->v_realisasi_biaya;
                                                $i       += $key->v_spb_realisasi;
                                                $u       += $key->v_nota_tertagih;
                                        ?>
                                        <?php }
                                        } ?>
                                        <tr>
                                            <th class="text-right" colspan="8"><strong>TOTAL</strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($m, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($i, 2); ?></strong></th>
