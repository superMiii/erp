                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control round text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line("Kode Gudang"); ?>" id="i_store_id" name="i_store_id" maxlength="100" autocomplete="off" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label><?= $this->lang->line("Nama Gudang"); ?> :</label>
                                    <div class="controls">
                                        <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line("Nama Gudang"); ?>" id="e_store_name" name="e_store_name" maxlength="500" autocomplete="off" required>
                                    </div>
                                </div>

                                <div class="form-group">
                                    <div class="controls skin-square">
                                        <input type="checkbox" id="chk-pusat" name="chk-pusat">
