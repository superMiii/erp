        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#" onclick="return false;"><?= $this->lang->line('Retur Penjualan'); ?></a></li>
                                    ...
                                    <div class="form-group row m-auto">
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_area" id="i_area" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Gudang"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                            ...
                                            <div class="col-md-2">
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <select name="rmu" id="rmu" class="form-control select2">
                                                            <option value="1" <?php if ('1' == $rmu) {
                                                                                    echo "selected";
                                                                                } ?>>Semua (PUSAT & CABANG)</option>
                                                            <option value="2" <?php if ('2' == $rmu) {
                                                                                    echo "selected";
                                                                                } ?>>PUSAT</option>
                                                            <option value="3" <?php if ('3' == $rmu) {
                                                                                    echo "selected";
                                                                                } ?>>CABANG</option>
                                                        </select>
                                                    </div>
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Jumlah SPB'); ?></th>
                                            <th><?= $this->lang->line('Jumlah SPB'); ?> ACC</th>
                                            <th><?= $this->lang->line('No SJ'); ?></th>
                                            <th><?= $this->lang->line('Tgl SJ'); ?></th>
                                            <th><?= $this->lang->line('Jumlah SJ'); ?></th>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <th class="text-right" colspan="7"><strong>TOTAL</strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($p, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($u, 2); ?></strong></th>
                                            <th class="text-right" colspan="2"><strong></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($r, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($t, 2); ?></strong></th>
