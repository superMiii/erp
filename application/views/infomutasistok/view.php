                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <h5 class="text-center text-bold-600 mb-0">Barang : <?= $e_product_name; ?></h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside2" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            <th width="3%;">No</th>
                                            <th><?= $this->lang->line('Referensi1'); ?></th>
                                            <th><?= $this->lang->line('Referensi2'); ?></th>
                                            ...
                                            <th class="text-right"><?= $this->lang->line('Git'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody class="font-small-3">
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?= $key->i_refference_id1; ?></td>
                                                    <td><?= $key->i_refference_id2; ?></td>
                                                    <td class="text-center"><?= $key->tanggal; ?></td>
                                                    <td><?= $key->e_note; ?></td>
                                                    <td class="text-right"><?= $key->debet; ?></td>
                                                    <td class="text-right"><?= $key->credit; ?></td>
                                                    <td class="text-right"><?= $key->belance; ?></td>
                                                    <td class="text-right"><?= $key->git; ?></td>
                                                </tr>
                                        <?php }
                                        } ?>
                                    </tbody>
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-right"><?= $belance; ?></th>
                                            <th class="text-right"><?= $git; ?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
