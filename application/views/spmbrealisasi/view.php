                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input type="date" class="form-control date" readonly value="<?= $data->d_sr; ?>" readonly data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                            ...
                                            <tbody>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        $nacc = ($key->n_acc == '' || $key->n_acc == null) ? 0 : $key->n_acc;
                                                        $i++; ?>
                                                        <tr>
                                                ...
                                                <?php
                                                        ...
                                                        $total_rupiah2 += $nacc *  $key->v_unit_price;
                                                    }
                                                } ?>
                                            </tbody>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td colspan="2" class="text-left">
                                                        <input type="text" class="form-control form-control-sm text-left" value="<?= number_format($total_rupiah2, 2); ?>" id="v_total" name="v_total" readonly>
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td colspan="6" class="text-right">
                                                        <b><i>( <span id="terbilangnya"> <?= terbilang($total_rupiah2); ?> rupiah </span> )</i></b>
                                                    </td>
                                                </tr>
                                            </tfoot>
                                        </table>
