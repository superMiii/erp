                                                ...
                                                foreach ($data->result() as $key) { ?>
                                                    <tr>
                                                        ...
                                                        foreach (json_decode($key->v_nota_netto) as $v_nota_netto) {
                                                            $x += $v_nota_netto;
                                                            if ($v_nota_netto > 0) { ?>
                                                                <td class="text-right <?= 'bln' . $c ?>" data-value="<?= $v_nota_netto ?>"><strong>Rp. <?= number_format($v_nota_netto); ?></strong></td>
                                                            <?php } else { ?>
                                                                <td class="text-right <?= 'bln' . $c ?>" data-value="<?= $v_nota_netto ?>">Rp. <?= number_format($v_nota_netto); ?></td>
                                                        <?php }
                                                            $c++;
                                                        } ?>
                                                        <td class="text-right"><strong>Rp. <?= number_format($x); ?></strong></td>
                                                    </tr>
                                            <?php $i++;
                                                }
                                            } ?>
