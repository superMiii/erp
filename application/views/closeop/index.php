                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <form class="form form-horizontal" action="<?= base_url($this->folder . '/closing'); ?>" method="post" id="formclose">
                                <div class="table-responsive">
                                    <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                        <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                            <tr>
                                                ...
                                                <th><?= $this->lang->line('Nomor Referensi'); ?></th>
                                                <th><?= $this->lang->line('Tgl Referensi'); ?></th>
                                    ...
                                    <div class="form-group row m-auto">
                                        <div class="col-md-6 row m-auto text-center">

                                            <div class="col-md-4">
                                                <?php echo "<a href='" . base_url() . $this->folder . "'><i class='fa fa-spin fa-refresh'></i>&nbsp;&nbsp;Refresh</a>"; ?>
                                            </div>

                                            <div class="col-md-4 ">
                                                <label class="custom-control custom-checkbox">
                                                    <input type="checkbox" id="checkAll" name="checkAll" class="">
