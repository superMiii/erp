                            ...
                            <form class="form-validation" novalidate>
                                        ...
                                        <select class="form-control select2" style="width: 100%" required data-placeholder="<?= $this->lang->line("Pilih"); ?> <?= $this->lang->line("Kategori Barang"); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" name="i_product_category">
                                            ...
                                            <?php if ($category->num_rows() > 0) {
                                                foreach ($category->result() as $key) { ?>
                                                    <option value="<?= $key->i_product_category; ?>" <?php if ($key->i_product_category == $data->i_product_category) { ?> selected <?php } ?>><?= $key->e_product_categoryname; ?></option>
                                            <?php }
                                            } ?>
                                        </select>
                                    </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="hidden" class="form-control" id="i_product_subcategory" name="i_product_subcategory" value="<?= $data->i_product_subcategory; ?>">
                                        <input type="hidden" class="form-control" id="i_product_subcategoryid_old" name="i_product_subcategoryid_old" value="<?= $data->i_product_subcategoryid; ?>">
                                        <input type="text" class="form-control text-uppercase" value="<?= $data->i_product_subcategoryid; ?>" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Kode Sub Kategori'); ?>" id="i_product_subcategoryid" name="i_product_subcategoryid" maxlength="100" autocomplete="off" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label><?= $this->lang->line('Nama Sub Kategori'); ?> :</label>
                                    <div class="controls">
                                        <input type="text" class="form-control text-capitalize" value="<?= $data->e_product_subcategoryname; ?>" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Nama Sub Kategori'); ?>" id="e_product_subcategoryname" name="e_product_subcategoryname" maxlength="500" autocomplete="off" required>
                                    </div>
                                </div>
