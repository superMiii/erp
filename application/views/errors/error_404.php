                            ...
                            <div class="card-content">
                                ...
                                <div class="row py-2">
                                    <div class="col-12 col-sm-6 col-md-6">
                                        <a href="<?= base_url();?>" class="btn btn-primary btn-block"><i
                                                class="ft-home"></i> Back to Home</a>
                                    </div>
                                    <div class="col-12 col-sm-6 col-md-6">
                                        <a href="<?= base_url();?>" class="btn btn-danger btn-block"><i
                                                class="ft-search"></i> Advanced search</a>
                                    </div>
                                </div>
                            </div>
                            <!-- <div class="card-footer bg-transparent">
                                <div class="row">
                                    <p class="text-muted text-center col-12 py-1">© 2016 <a href="#">Stack </a>Crafted
                                        with <i class="ft-heart pink"> </i> by <a
