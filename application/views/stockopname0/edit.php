                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input type="date" class="form-control" readonly min="<?= get_min_date(); ?>" max=<?= date('Y-m-d'); ?> value="<?= $data->d_stockopname; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="hidden" name="i_product[]" id="i_product<?= $i; ?>" value="<?= $key->i_product; ?>"><?= $key->i_product_id; ?>
                                                            </td>
