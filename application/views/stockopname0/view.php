                                ...
                                <div class="col-md-3">
                                    <div class="form-group">
                                        ...
                                        <div class="input-group controls">
                                            ...
                                            <input type="date" class="form-control" readonly max=<?= date('Y-m-d'); ?> value="<?= $data->d_stockopname; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control" readonly value="<?= $data->i_store_loc_id . ' - ' . $data->e_store_name . ' - ' . $data->e_store_loc_name; ?>" placeholder="" maxlength="500" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <table class="table table-xs table-column table-bordered" id="tablecover">
                                        <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                            <tr>
                                                ...
                                                <th class="text-right" width="10%"><?= $this->lang->line("Jumlah"); ?></th>
                                            </tr>
                                        </thead>
                                        <tbody>
                                            <?php $i = 0;
