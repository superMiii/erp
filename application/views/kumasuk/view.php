                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="text" readonly name="i_document" id="i_document" value="<?= $data->i_kum_id; ?>" placeholder="No Giro" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" readonly class="form-control form-control-sm date" min="2021-10-01" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_kum; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly value="<?= $data->e_atasnama; ?>" class="form-control" required name="e_atasnama" id="e_atasnama" placeholder="<?= $this->lang->line("Atas Nama Pengirim"); ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
