                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Tgl App Sales'); ?></th>
                                            <th><?= $this->lang->line('Tgl App AR'); ?></th>
                                            <th><?= str_replace('\r\n', "<br>", $this->lang->line('SPBApp1')); ?></th>
                                            <th><?= str_replace('\r\n', "<br>", $this->lang->line('SPBApp2')); ?></th>
                                            ...
                                            <th><?= $this->lang->line('Nilai Pesanan'); ?></th>
                                            <th><?= $this->lang->line('Nilai Pemenuhan'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                </table>
