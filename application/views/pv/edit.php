                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm date" min="<?= get_min_date2(); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_pv; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select readonly class="form-control" name="i_pv_type" id="i_pv_type" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Tipe Voucher"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                        <option value="<?= $data->i_pv_type; ?>"><?= $data->i_pv_type_id . ' - ' . $data->e_pv_type_name; ?></option>
                                                    </select>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    ...
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="date" max="<?= $data->d_pv; ?>" value="<?= $key->d_bukti; ?>" class="form-control isi form-control-sm" id="d_bukti<?= $i; ?>" name="d_bukti[]"></td>
                                                            <td class="clear" <?= $tex; ?>><select data-nourut="<?= $i; ?>" class="form-control select2-size-sm" name="i_pv_refference_type[]" id="i_pv_refference_type<?= $i; ?>">
                                                                    <option value="<?= $key->i_pv_refference_type; ?>"><?= $key->e_pv_refference_type_name; ?></option>
                                                                </select></td>
                                                            <td class="clear" <?= $tex; ?>><select data-nourut="<?= $i; ?>" class="form-control select2-size-sm" name="i_pv_refference[]" id="i_pv_refference<?= $i; ?>">
                                                                    <option value="<?= $key->i_pv_refference; ?>"><?= $key->i_referensi; ?></option>
                                                                </select></td>
                                                            <input type="hidden" class="form-control isi form-control-sm" value="<?= $key->v_pv; ?>" id="jum<?= $i; ?>" name="jum[]">
                                                            <td><input type="text" class="form-control isi form-control-sm" value="<?= $key->e_remark; ?>" id="e_remark_item<?= $i; ?>" name="e_remark_item[]"></td>
                                                            <td><input type="text" class="formatrupiah isi form-control form-control-sm text-right v_pv" value="<?= number_format($key->v_pv); ?>" id="v_pv_item<?= $i; ?>" name="v_pv_item[]" onkeyup="reformat(this);hetang();juma(<?= $i; ?>);" autocomplete="off" onblur="if(this.value==''){this.value='0';hitung();}" onfocus="if(this.value=='0'){this.value='';}"></td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th><input type="text" class="form-control form-control-sm text-right" name="v_pv" id="v_pv" value="<?= number_format($subtotal); ?>" readonly></th>
                                                </tr>
                                                <tr>
                                            ...
                                            <input type="hidden" id="tex" name="tex" value="<?= $data->i_pv_type_id ?>">
