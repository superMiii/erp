                        ...
                        <div class="invoice-logo-title row">
                            <div class="col-9 d-flex flex-column justify-content-center align-items-start">
                                ...
                                <p class="font-large-2 text-uppercase text-primary"><?= $company->e_company_name; ?>
                                    <input type="hidden" id="id" value="<?= $data->i_pv; ?>">
                        ...
                        <div class="row mb-1">
                            <div class="col-12">
                                <div class="info-title text-center">
                                    <span class="text-bold-700 font-large-1 text-uppercase">Bukti Pembayaran <?= $data->e_coa_name; ?></span>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row invoice-adress-info">
                            <div class="col-6 from-info">
                                <div class="info-title">
                                    <span class="text-muted">NO. </span><span class="font-medium-1"><?= $data->i_pv_id; ?></span>
                                </div>
                            </div>
                            <div class="col-6 to-info">
                                <div class="info-title text-right mb-1">
                                    <p class="font-medium-3 text-capitalize"><?= $data->e_area_name . ', ' . date('d', strtotime($data->d_pv)) . ' ' . bulan(date('m', strtotime($data->d_pv))) . ' ' . date('Y', strtotime($data->d_pv)); ?></p>
                                </div>
                            </div>
                        </div>
