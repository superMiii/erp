    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            <td class="text-center" colspan="2">
                <p class="header text-bold-700">Bukti Penerimaan <?= $data->e_coa_name; ?></p>
            </td>
        </tr>
        <tr>
            <td><span class="judul header text-bold-700"><?= $data->i_pv_id; ?></span></td>
            <td class="text-right"><span class="judul header text-bold-700"><?= $data->e_area_name . ', ' . date('d', strtotime($data->d_pv)) . ' ' . bulan(date('m', strtotime($data->d_pv))) . ' ' . date('Y', strtotime($data->d_pv)); ?></span></td>
        </tr>
    </table>
