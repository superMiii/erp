                                    ...
                                    <div class="row">
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select class="form-control" name="i_pv_type" id="i_pv_type" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Tipe Voucher"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                        <option value=""></option>
                                                    </select>
                                                </div>
                                            </div>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th><input type="text" class="form-control form-control-sm text-right" name="v_pv" id="v_pv" value="0" readonly></th>
                                                </tr>
                                                <tr>
