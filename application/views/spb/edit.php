                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center" width="23%" valign="center"><?= $this->lang->line("Nama Barang"); ?></th>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" id="n_order<?= $i; ?>" value="<?= $key->n_order; ?>" name="n_order[]" class="form-control text-center n_order form-control-sm"  onkeyup="hitung()" onblur="if(this.value=='' ){this.value='1' ;hitung();}" onfocus="if(this.value=='1' ){this.value='' ;}"></td>
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <th colspan="7" class="text-right hidden"><?= $this->lang->line("Diskon"); ?></th>
                                                ...
                                                <tr>
                                                    <th colspan="7" class="text-right hidden"><?= $this->lang->line("Diskon Rp"); ?>. </th>
