                                    ...
                                    <div class="form-group row m-auto">
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_product" id="i_product" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Barang"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                            ...
                            <div class="table-responsive">
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            <th>No</th>
                                            <th><?= $this->lang->line('No Dok'); ?></th>
                                            <th><?= $this->lang->line('Tgl Kirim'); ?></th>
                                            ...
                                            <th><?= $this->lang->line('Qty Kirim'); ?></th>
                                            <th><?= $this->lang->line('Qty Terima'); ?></th>
                                    ...
                                    <tfoot>
                                        ...
                                        if ($data->num_rows() > 0) {
                                            foreach ($data->result() as $key) {
                                                $p3       += $key->n_quantity_deliver;
                                                $q3       += $key->n_quantity_receive;
                                        ?>
                                        <?php }
                                        } ?>
                                        <tr>
