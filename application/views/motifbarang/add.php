                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control round text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line("Kode Motif"); ?>" id="i_product_motifid" name="i_product_motifid" maxlength="100" autocomplete="off" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label><?= $this->lang->line("Nama Motif"); ?> :</label>
                                    <div class="controls">
                                        <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line("Nama Motif"); ?>" id="e_product_motifname" name="e_product_motifname" maxlength="500" autocomplete="off" required>
                                    </div>
                                </div>
