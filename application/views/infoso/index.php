                                            ...
                                            <div class="col-md-6">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_stockopname" id="i_stockopname" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Stock Opname"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                            <option value="<?= $i_stockopname; ?>"><?= $i_stockopname_id; ?></option>
                                                            <!-- <option value="<?= $i_stockopname; ?>"><?= $i_stockopname_id . " - " . $e_area_name; ?></option> -->
                                                        </select>
                                                    </div>
                                                </fieldset>
                                            </div>
