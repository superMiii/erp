                            ...
                            <div class="table-responsive">
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            <th>No</th>
                                            <th><?= $this->lang->line('No TTB'); ?></th>
                                            <th><?= $this->lang->line('Tgl TTB'); ?></th>
                                            <th><?= $this->lang->line('Nama Pramuniaga'); ?></th>
                                            <th><?= $this->lang->line('Nama Area Provinsi'); ?></th>
                                            <th><?= $this->lang->line('Nama Pelanggan'); ?></th>
                                            <th><?= $this->lang->line('Alasan Retur'); ?></th>
                                            ...
                                            <th><?= $this->lang->line('Jumlah TTB'); ?></th>                                          
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                    <tfoot>
                                        ...
                                        <tr>
                                            <th class="text-right" colspan="10"><strong>TOTAL</strong></th>
                                            <th ><strong><?= number_format($mi); ?></strong></th>
                                            <th ><strong><?= number_format($na); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($q, 0); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($w, 0); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($e, 0); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($r, 0); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($t, 0); ?></strong></th>
                                            <th ><strong></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($y, 0); ?></strong></th>
                                        </tr>
