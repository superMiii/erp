                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" readonly class="form-control form-control-sm date" value="<?= date('Y-m-d', strtotime($data->d_so)); ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-6">
                                            ...
                                            <div class="controls">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input disabled type="checkbox" <?php if ($data->f_so_stockdaerah == 't') {
                                                                                            echo "checked";
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                <input type='text' value="<?php if ($data->d_po_reff != '' || $data->d_po_reff != null) {
                                                                            ...
                                                                            } ?>" readonly class="form-control form-control-sm date" placeholder="<?= $this->lang->line('Tanggal PO'); ?>" />
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <span class="fa fa-calendar-o"></span>
                                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input readonly class="form-control form-control-sm" value="<?= $data->i_product_groupid . ' - ' . $data->e_product_groupname; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-7">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input autofocus class="form-control form-control-sm" placeholder="<?= $this->lang->line('Alasan Setuju / Tidak Setuju'); ?>" id="e_note" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <input type="hidden" name="pla" id="pla" class="form-control" value="<?= $data->pla; ?>">
                                <input type="hidden" name="bl" id="bl" class="form-control" value="<?= $data->bl; ?>">

                                <div class="form-actions">
                                    <button type="button" onclick="app('<?= $this->folder; ?>','<?= $data->i_so; ?>','<?= encrypt_url($dfrom); ?>','<?= encrypt_url($dto); ?>','<?= encrypt_url($harea); ?>');" class="btn btn-info round btn-min-width mr-1"><i class="fa fa-check-circle fa-lg mr-1"></i><?= $this->lang->line("Menyetujui"); ?></button>
                                    <button type="button" onclick="notapp('<?= $this->folder; ?>','<?= $data->i_so; ?>','<?= encrypt_url($dfrom); ?>','<?= encrypt_url($dto); ?>','<?= encrypt_url($harea); ?>');" class="btn btn-danger round btn-min-width mr-1"><i class="fa fa-times-circle-o fa-lg mr-1"></i><?= $this->lang->line("Tidak Menyetujui"); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center" width="20%" valign="center"><?= $this->lang->line("Nama Barang"); ?></th>
                                                    ...
                                                    <th class="text-center" width="8%"><?= $this->lang->line("Disk4"); ?> %</th>
                                            ...
                                            <tfoot>
                                                ...
                                                <tr>
                                                    <th colspan="8" class="text-right"><?= $this->lang->line("Diskon"); ?></th>
                                                ...
                                                <tr>
                                                    <th colspan="8" class="text-right"><?= $this->lang->line("Diskon Rp"); ?>. </th>
                                                    <th><input type="text" readonly class="formatrupiah form-control form-control-sm text-right" value="<?= number_format($data->v_so_discounttotal, 2); ?>" onkeyup="formatrupiahkeyup(this);change_vdisc();hitung();" onkeydown="formatrupiahkeydown(this);change_vdisc();hitung();" onblur="if(this.value==''){this.value='0';hitung();}" onfocus="if(this.value=='0'){this.value='';}" id="tfoot_v_diskon" name="tfoot_v_diskon"></th>
                                                </tr>
                                                <tr>
