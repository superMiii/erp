                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="input-group control">
                                                    ...
                                                    <input type="text" name="i_document" id="i_document" value="<?= $data->i_gi_id; ?>" readonly placeholder="PS-<?= date('ym'); ?>-000001" class="form-control text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                </div>
                                    ...
                                    <div class="col-sm-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control date" value="<?= date('d-m-Y', strtotime($data->d_gi)); ?>" readonly data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
