                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                <input type="text" class="form-control form-control-sm" value="<?= date('d-m-Y', strtotime($data->d_nota)); ?>" readonly data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                <input type="text" class="form-control form-control-sm" value="<?= date('d-m-Y', strtotime($data->d_do)); ?>" readonly data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <span class="fa fa-calendar-o"></span>
                                                    </span>
                                ...
                                <div class="row">
                                            ...
                                            <div class="controls">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input type="checkbox" disabled id="f_masalah" name="f_masalah" class="switch" data-group-cls="btn-group-sm" data-on-label="<?= $this->lang->line('Ya'); ?>" data-off-label="<?= $this->lang->line('Tidak'); ?>" data-switch-always />
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input type="checkbox" disabled id="f_insentif" name="f_insentif" checked class="switch" data-group-cls="btn-group-sm" data-on-label="<?= $this->lang->line('Ya'); ?>" data-off-label="<?= $this->lang->line('Tidak'); ?>" data-switch-always />
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                <input type="text" class="form-control form-control-sm" value="<?= date('d-m-Y', strtotime('+' . $data->n_so_toplength . ' days', strtotime($data->d_do))); ?>" readonly data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_jatuh_tempo" name="d_jatuh_tempo" autocomplete="off" required>
                                                <div class="input-group-append">
                                                    <span class="input-group-text">
                                                        <span class="fa fa-calendar-o"></span>
                                                    </span>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea type="text" rows="3" class="form-control form-control-sm" readonly name="e_remark"><?= $data->e_remark; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr class="align-baseline">
                                                            ...
                                                            <td class="text-right"><?= number_format($key->n_deliver); ?></td>
                                                            <td class="text-right"><?= number_format($key->n_nota_discount1); ?></td>
                                                            <td class="text-right"><?= number_format($key->n_nota_discount2); ?></td>
                                                            <td class="text-right"><?= number_format($key->n_nota_discount3); ?></td>
