                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                ...
                                <div class="form-actions">
                                    <button type="submit" id="submit" class="btn <?= $this->session->e_color; ?> bg-darken-3 text-white btn-min-width"><i class="icon-paper-plane mr-1"></i><?= $this->lang->line("Ubah"); ?></button>
