                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="text" name="i_document" id="i_document" readonly placeholder="PO-<?= date('ym'); ?>-000001" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" <?= koncix(); ?> class="form-control form-control-sm" min="<?= get_min_date(); ?>" max="<?= date('Y-m-d'); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document_submit" maxlength="500" value="<?= date('Y-m-d'); ?>" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" <?= koncix(); ?> class="form-control form-control-sm date" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_estimation" name="d_estimation" maxlength="500" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea class="form-control text-capitalize" placeholder="<?= $this->lang->line('Remark'); ?>" id="e_po_remark" name="e_po_remark" autocomplete="off"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?= base_url($this->folder . '/add/' . encrypt_url($dfrom) . '/' . encrypt_url($dto)); ?>" class="btn btn-secondary round btn-min-width mr-1"><i class="icon-action-undo mr-1"></i><?= $this->lang->line("Kembali"); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
