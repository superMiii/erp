                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="text" class="form-control form-control-sm" value="<?= date('Y-m-d'); ?>" <?= konci(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                ...
                                <div class="row">
                                    <div class="col-sm-8">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly value="<?= $data->e_remark; ?>" class="form-control form-control-sm text-uppercase">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center" valign="center"><?= $this->lang->line("Jml Pengembalian"); ?></th>
                                                    <th class="text-center" valign="center"><?= $this->lang->line("Jml Acc"); ?></th>
                                                    <th class="text-center" width="15%;" valign="center"><?= $this->lang->line("Jml Terima"); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php $i = 0;
                                            ...
                                            <input type="hidden" value="<?= number_format($total_rupiah, 2); ?>" id="v_total" name="v_total" readonly>
                                            <!-- <tfoot>
                                                <tr>
                                ...
                                <div class="form-actions">
                                    <button type="submit" id="submit" class="btn btn-info round btn-min-width mr-1"><i class="fa fa-check-circle fa-lg mr-1"></i><?= $this->lang->line("Terima"); ?></button>
