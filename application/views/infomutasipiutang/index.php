                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Alokasi BM'); ?></th>
                                            <th><?= $this->lang->line('Alokasi KN Retur'); ?></th>
                                            <th><?= $this->lang->line('Alokasi KN Non Retur'); ?></th>
                                            <th><?= $this->lang->line('Alokasi Hutang Lain-lain'); ?></th>
                                            <th><?= $this->lang->line('Pembulatan'); ?></th>
