                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body">
                            ...
                            <?php echo form_open_multipart('Main/user') ?>

                                <!-- Step 1 -->
                                <!-- <h6><?= $this->lang->line('Profil Saat Ini'); ?></h6> -->
                                <fieldset>
                                    <div class="row">
                                        <div class="col-md-1">
                                                ...
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <td class="text-center">
                                                            <img src="<?php echo base_url(); ?>assets/images/avatar/<?= $data->ava; ?>" width="400" height="490">
                                                        </td>
                                                    </tr>
                                                </thead>
                                            </table>
