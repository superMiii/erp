                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input type="date" <?= konci(); ?> min="<?= get_min_date(); ?>" max="<?= date('Y-m-d'); ?>" class="form-control date" value="<?= $data->d_gs; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select class="form-control" id="i_store" name="i_store" data-placeholder="<?= $this->lang->line("Pilih"); ?> <?= $this->lang->line("Gudang"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                    <option value="<?= $data->i_store; ?>"><?= $data->e_store_name; ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                                    ...
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="text" value="<?= $key->e_product_gradename; ?>" id="e_product_gradename<?= $i; ?>" readonly class="form-control form-control-sm">
                                                            </td>
                                                            <td><input type="number" value="<?= $key->n_stk; ?>" readonly name="n_stk[]" id="n_stk<?= $i; ?>" class="form-control form-control-sm"></td>
                                                            <td><input type="number" value="<?= $key->n_quantity_order; ?>" name="n_order[]" id="n_order<?= $i; ?>" class="form-control form-control-sm" onkeyup="hetang(<?= $i; ?>);" onblur="if(this.value=='' ){this.value='0' ;}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                            <td><input type="number" value="<?= $key->n_quantity_deliver; ?>" readonly name="n_acc[]" id="n_acc<?= $i; ?>" class="form-control form-control-sm"></td>
