                            ...
                            <form class="form-validation" novalidate>
                                <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control text-capitalize" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Kode Lokasi Gudang'); ?>" id="i_store_loc_id" name="i_store_loc_id" maxlength="100" autocomplete="off" required autofocus>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control text-capitalize" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Nama Lokasi Gudang'); ?>" id="e_store_loc_name" name="e_store_loc_name" maxlength="500" autocomplete="off" required autofocus>
                                        </div>
                                    </div>
                                </div>
