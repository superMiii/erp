                                    ...
                                    <div class="form-group row m-auto">
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_product" id="i_product" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Area"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                            ...
                            <div class="table-responsive">
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            <th>No</th>
                                            <th><?= $this->lang->line('No. Konversi'); ?></th>
                                            <th><?= $this->lang->line('Tgl. Konversi'); ?></th>
                                            <th><?= $this->lang->line('Kode'); ?></th>
                                            <th><?= $this->lang->line('Barang Asal'); ?></th>
                                            <th><?= $this->lang->line('Jumlah Asal'); ?></th>
                                            <th><?= $this->lang->line('Kode Barang'); ?></th>
                                            <th><?= $this->lang->line('Nama Barang'); ?></th>
                                            <th><?= $this->lang->line('Jml Konversi'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                    <tfoot>
