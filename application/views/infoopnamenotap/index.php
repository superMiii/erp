                                        ...
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-4">
                                                <div class="row skin skin-square">
                                                    <fieldset>
                                                        <input type="radio" name="f_jatuh" id="input-radio-11" value="f" <?php if ($f_jatuh == 'f') {
                                                                                                                                echo "checked";
                                                                                                                            } ?>>
                                                        <label for="input-radio-11"><?= $this->lang->line('Tgl Nota'); ?></label>
                                                    </fieldset>
                                                    <fieldset>
                                                        <input type="radio" name="f_jatuh" id="input-radio-12" value="t" <?php if ($f_jatuh == 't') {
                                                                                                                                echo "checked";
                                                                                                                            } ?>>
                                                        <label for="input-radio-12"><?= $this->lang->line('Tgl Jatuh Tempo'); ?></label>
                                                    </fieldset>
                                                </div>
                                            </div>
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_supplier" id="i_supplier" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Supplier"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('PKP'); ?></th>
                                            <th><?= $this->lang->line('TOP'); ?></th>
                                            <th><?= $this->lang->line('Nota Pembelian'); ?></th>
                                            <th><?= $this->lang->line('Tgl Nota Pembelian'); ?></th>
                                            <th><?= $this->lang->line('Tgl Jatuh Tempo'); ?></th>
                                            <th><?= $this->lang->line('Jumlah Nota'); ?></th>
                                            <th><?= $this->lang->line('Sisa Nota'); ?></th>
                                            <th><?= $this->lang->line('Status'); ?></th>
                                            <th><?= $this->lang->line('Umur Hutang'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right"><strong>Rp. <?= number_format($ka, 2); ?></strong></th>
