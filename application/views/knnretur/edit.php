                                        ...
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm date" min="<?= get_min30(); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_kn; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <fieldset>
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="number" name="i_refference" id="i_refference" value="<?= $data->i_refference; ?>" placeholder="000001" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm date" min="<?= get_min30(); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_refference; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_refference" name="d_refference" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                <div class="controls">
                                                    <fieldset>
                                                        <div class="float-left">
                                                            <input type="checkbox" id="f_masalah" name="f_masalah" <?php if ($data->f_masalah == 't') {
                                                                                                                        echo "checked";
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <fieldset>
                                                        <div class="float-left">
                                                            <input type="text" id="v_netto" value="<?= number_format($data->v_netto); ?>" readonly name="v_netto" class="form-control form-control-sm" autocomplete="off" onkeyup="reformat(this);" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line("Bersih"); ?>" />
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-2">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <fieldset>
                                                        <div class="float-left">
                                                            <input type="text" id="v_sisa" value="<?= number_format($data->v_sisa); ?>" readonly name="v_sisa" class="form-control form-control-sm" autocomplete="off" onkeyup="reformat(this);" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line("Sisa"); ?>" />
                                                        </div>
                                                    </fieldset>
                                                </div>
                                            </div>
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <textarea class="form-control text-capitalize" placeholder="<?= $this->lang->line('Keterangan'); ?>" id="e_remark" name="e_remark"><?= $data->e_remark; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
