                        ...
                        <div class="invoice-logo-title row">
                            <div class="col-9 d-flex flex-column justify-content-center align-items-start">
                                ...
                                <p class="font-large-2 text-uppercase text-primary">
                                    <input type="hidden" id="id" value="<?= $data->i_kn; ?>"><?= $this->lang->line('Kredit Nota Non Retur'); ?>
                                    <input type="hidden" id="path" value="<?= base_url($this->folder); ?>">
                                    <br><span class="font-medium-3 font-weight-bold">Nomor KN : <?= $data->i_kn_id; ?></span>
                                    <br><span class="font-medium-3 font-weight-bold">Tanggal KN : <?= date('d', strtotime($data->d_kn)) . ' ' . bulan(date('m', strtotime($data->d_kn))) . ' ' . date('Y', strtotime($data->d_kn)); ?></span>
                                </p>
                            </div>
                                ...
                                <table class="table table-xs table-bordered mt-0 mb-0">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="text-center" scope="col"><?= $this->lang->line('Kotor'); ?></th>
                                            <th class="text-center" scope="col"><?= $this->lang->line('Potongan'); ?></th>
                                            <th class="text-center" scope="col"><?= $this->lang->line('Bersih'); ?></th>
                                            <th class="text-center" scope="col"><?= $this->lang->line("Sisa"); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-right"><?= number_format($data->v_gross); ?></td>
                                            <td class="text-right"><?= number_format($data->v_discount); ?></td>
                                            <td class="text-right"><?= number_format($data->v_netto); ?></td>
                                            <td class="text-right"><?= number_format($data->v_sisa); ?></td>
                                            <td><?= $data->e_remark; ?></td>
                                        </tr>
                                        <?php
                                        // $subtotal += $total;
