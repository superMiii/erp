                                                ...
                                                <div class="form-group">
                                                    <div class="controls">
                                                        <select name="pro" id="pro" class="form-control select2">
                                                            ...
                                                            <option value="4" <?php if ('4' == $pro) {
                                                                                    echo "selected";
                                                                                } ?>>PULAU KALIMANTAN</option>
                                                            <option value="5" <?php if ('5' == $pro) {
                                                                                    echo "selected";
                                                                                } ?>>PULAU NUSA TENGGARA</option>
                                                            <option value="6" <?php if ('6' == $pro) {
                                                                                    echo "selected";
                                                                                } ?>>PULAU PAPUA</option>
                                                            <option value="7" <?php if ('7' == $pro) {
                                                                                    echo "selected";
                                                                                } ?>>PULAU SULAWESI</option>
                                                            <option value="8" <?php if ('8' == $pro) {
                                                                                    echo "selected";
                                                                                } ?>>PULAU SUMATERA</option>
                                                        </select>
                                                    </div>
                                                </div>
                                            </div>
