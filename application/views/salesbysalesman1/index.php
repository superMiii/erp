                                    ...
                                    <?php 
                                        ...
                                        ?>
                                                 <tr>
                                                    ...
                                                    <th class="text-center">Rp. <?php number_format($key->v_target, 2) ?></th>
                                                    <th class="text-center">Rp. <?php number_format($key->v_realisasi, 2) ?></th>
                                                    <th class="text-center">0</th>
                                                    <th class="text-center">Rp. <?php number_format($key->targ, 2) ?></th>
                                                    <th class="text-center">Rp. <?php number_format($key->reals, 2) ?></th>
                                                    <th class="text-center">0</th>
                                                    <td class="text-right"><?= number_format($key->ob); ?></td>
                                                    <td class="text-right"><?= number_format($key->oa); ?></td>
                                                    <td class="text-right"><?= number_format($key->oaa); ?></td>
                                                    <td class="text-right">0</td>
                                                    <td class="text-right"><?= number_format($key->krm); ?></td>
                                                    <td class="text-right"><?= number_format($key->krmm); ?></td>
                                                    <td class="text-right">0</td>
                                                    <td class="text-right">Rp. <?= number_format($key->yui, 2); ?></td>
                                                    <td class="text-right">Rp. <?= number_format($key->yuii, 2); ?></td>
                                                    <td class="text-right">0</td>
                                                    <td class="text-right">0</td>
                                                </tr>
                                        <?php }
