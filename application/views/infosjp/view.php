        ...
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="<?= base_url($this->folder . '/index/' . $dfrom . '/' . $dto . '/' . $i_store); ?>"><?= $this->lang->line($this->title); ?></a></li>
                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <h4 class="text-center mb-0"><?= $this->title . ' - ' . $e_store_name; ?></h4>
                            <h5 class="text-center text-bold-600 mb-0">No. SJP : <?= $i_gs_id; ?></h5>
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside2" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Jml Acc'); ?></th>
                                            <th><?= $this->lang->line('Jml Kirim'); ?></th>
                                            <th><?= $this->lang->line('Jml Terima'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody>
                                        <?php $i = 0;
                                        ...
                                        if ($detail->num_rows() > 0) {
                                            foreach ($detail->result() as $key) {
                                                $i++;
                                                $acc += $key->n_quantity_order;
                                                $krm += $key->n_quantity_deliver;
                                                $trm += $key->n_quantity_receive;
                                        ?>
                                                <tr>
                                                    <td class="text-center"><?= $i; ?></td>
                                                    <td><?= $key->i_gs_item_id; ?></td>
                                                    <td><?= $key->e_area; ?></td>
