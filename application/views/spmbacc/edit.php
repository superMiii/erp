                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="hidden" value="<?= $data->i_area; ?>" name="i_area" id="i_area" class="form-control" readonly />
                                                <select readonly class="form-control" id="i_area3" data-placeholder="<?= $this->lang->line("Pilih"); ?> <?= $this->lang->line("Area"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea type="text" name="e_remark" readonly class="form-control" placeholder="<?= $this->lang->line("Keterangan"); ?>"><?= $data->e_remark; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tablecover">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" value="<?= $key->n_order; ?>" name="n_acc[]" id="n_acc<?= $i; ?>" class="form-control form-control-sm" onkeypress="return bilanganasli(event);raya();" onkeyup="raya();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <td colspan="2" class="text-right">
                                                        <input type="text" class="form-control form-control-sm text-right" value="<?= number_format($total_rupiah, 0); ?>" id="v_total0" name="v_total0" readonly>
                                                    </td>
                                                </tr>
                                                <tr>
