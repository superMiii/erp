                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="text" name="i_document" id="i_document" readonly placeholder="CGR-<?= date('ym'); ?>-000001" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                </div>
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" maxlength="3" class="form-control form-control-sm text-capitalize" placeholder="<?= $this->lang->line('Jumlah Bal'); ?>" id="n_bal" name="n_bal" autocomplete="off" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th><input type="text" class="form-control form-control-sm text-right" name="v_cgr" id="v_cgr" value="0" readonly></th>
                                                </tr>
                                            </tfoot>
