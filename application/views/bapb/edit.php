                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <!-- <input type="date" class="form-control form-control-sm date" <?= konci(); ?> min="2021-10-01" max="<?= date('Y-m-d'); ?>" value="<?= date('Y-m-d'); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required> -->
                                                <input type="date" class="form-control form-control-sm date" <?= konci(); ?> min="2021-10-01" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_cgr; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select class="form-control select2" name="i_customer" id="i_customer" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Pelanggan"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="number" value="<?= $data->n_bal; ?>" maxlength="3" class="form-control form-control-sm text-capitalize" placeholder="<?= $this->lang->line('Jumlah Bal'); ?>" id="n_bal" name="n_bal" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select data-nourut="<?= $i; ?>" required class="form-control select2-size-sm" name="i_do[]" id="i_do<?= $i; ?>">
                                                                    <option value="<?= $key->i_do; ?>"><?= $key->i_do_id; ?></option>
                                                                </select>
                                                            </td>
                                                            <td>
                                                                <input type="hidden" value="<?= $key->d_do; ?>" id="d_do<?= $i; ?>" name="d_do[]" readonly>
                                                                <input type="text" value="<?= $key->date_do; ?>" readonly class="form-control form-control-sm" id="date_do<?= $i; ?>" readonly>
                                                            </td>
                                                            <td><input type="text" value="<?= number_format($key->v_jumlah); ?>" readonly class="form-control form-control-sm text-right v_jumlah" id="v_jumlah<?= $i; ?>" name="v_jumlah[]" readonly></td>
                                                            <td><input type="text" value="<?= $key->e_remark; ?>" class="form-control form-control-sm" id="e_remark<?= $i; ?>" name="e_remark[]"></td>
                                            ...
                                            <tfoot>
                                                <tr>
                                                    ...
                                                    <th><input type="text" class="form-control form-control-sm text-right" name="v_cgr" id="v_cgr" value="<?= number_format($data->v_cgr); ?>" readonly></th>
                                                </tr>
                                            </tfoot>
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetailx">
                                            <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center" valign="center"><?= $this->lang->line("Keterangan"); ?></th>
                                                    <th class="text-center" width="3%"><i class="fa fa-plus-circle fa-lg" title="<?= $this->lang->line('Ubah'); ?>" id="addrowx"></i></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php $ii = 0;
                                                if ($detailx->num_rows() > 0) {
                                                    foreach ($detailx->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select data-nourut="<?= $ii; ?>" required class="form-control select2-size-sm" name="i_sl_ekspedisi[]" id="i_sl_ekspedisi<?= $ii; ?>">
                                                                    <option value="<?= $key->i_cgr_ekspedisi; ?>"><?= '[ ' . $key->i_sl_ekspedisi_id . ' ] ' . $key->e_sl_ekspedisi; ?></option>
                                                                </select>
                                                            </td>
                                                            <td><input type="text" value="<?= $key->e_remark; ?>" class="form-control form-control-sm" id="e_remark_ekspedisi<?= $ii; ?>" name="e_remark_ekspedisi[]"></td>
                                                            <td class="text-center"><i title="Delete" class="fa fa-minus-circle fa-lg text-danger ibtnDel"></i></td>
                                                        </tr>
                                                <?php }
                                                } ?>
