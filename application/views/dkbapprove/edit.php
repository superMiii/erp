                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" class="form-control form-control-sm" value="<?= date('Y-m-d', strtotime($data->d_sl)); ?>" <?= konci(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input autofocus class="form-control form-control-sm" placeholder="<?= $this->lang->line('Alasan Setuju'); ?>" id="e_note" value="">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-actions">
                                    <button type="button" onclick="app('<?= $this->folder; ?>','<?= $data->i_sl; ?>','<?= encrypt_url($dfrom); ?>','<?= encrypt_url($dto); ?>','<?= encrypt_url($harea); ?>');" class="btn btn-success btn-min-width"><i class="fa fa-check-circle fa-lg mr-1"></i><?= $this->lang->line("Menyetujui"); ?></button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="card">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                ...
                                <div class="form-actions">
                                    <a href="<?= base_url($this->folder . '/index/' . encrypt_url($dfrom) . '/' . encrypt_url($dto) . '/' . encrypt_url($harea)); ?>" class="btn btn-secondary round btn-min-width mr-1"><i class="fa fa-check-circle fa-lg mr-1"></i><?= $this->lang->line("Kembali"); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
