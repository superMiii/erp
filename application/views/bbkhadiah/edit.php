                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="input-group input-group-sm control">
                                                    ...
                                                    <input type="text" name="i_document" id="i_document" value="<?= $data->i_bbk_id; ?>" readonly placeholder="BBK-<?= date('ym'); ?>-000001" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" <?= koncix(); ?> class="form-control form-control-sm date" min="<?= date('Y-m-01'); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_bbk; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select class="form-control" id="i_customer" name="i_customer" data-placeholder="<?= $this->lang->line("Pilih"); ?> <?= $this->lang->line("Pelanggan"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea type="text" required name="e_remark" data-validation-required-message="<?= $this->lang->line("Required"); ?>" class="form-control" required placeholder="<?= $this->lang->line("Keterangan"); ?>"><?= $data->e_remark; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" value="<?= $key->n_stk; ?>" readonly name="n_stk[]" id="n_stk<?= $i; ?>" class="form-control form-control-sm"></td>
                                                            <td><input type="number" value="<?= $key->n_quantity; ?>" name="n_order[]" id="n_order<?= $i; ?>" class="form-control form-control-sm" onkeyup="raya(<?= $i; ?>);" onblur="if(this.value=='' ){this.value='0' ;}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
