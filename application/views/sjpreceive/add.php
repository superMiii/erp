            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url($this->folder . '/indexx'); ?>"><?= $this->lang->line('Surat Permintaan Barang'); ?></a></li>
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" class="form-control form-control-sm" max="<?= date('Y-m-d'); ?>" value="<?= date('Y-m-d'); ?>" <?= konci(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="text" class="form-control form-control-sm" value="<?= $data->d_sr; ?>" <?= koncix(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_sr" name="d_sr" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" value="" autocomplete="off" class="form-control form-control-sm text-left" id="e_remark<?= $i; ?>" name="e_remark[]"></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
