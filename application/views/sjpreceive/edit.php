                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="text" class="form-control form-control-sm" value="<?= $data->d_gs; ?>" <?= konci(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" readonly class="form-control form-control-sm" value="<?= $data->d_sr; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_sr" name="d_sr" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" min="<?= $data->d_gs; ?>" readonly max="<?= date('Y-m-d'); ?>" value="<?= date('Y-m-d'); ?>" <?= koncix(); ?> class="form-control form-control-sm" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_receive" name="d_receive" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            ?>
                                                            <td><input type="text" value="<?= $key->n_quantity_deliver;  ?>" autocomplete="off" class="form-control text-right n_order form-control-sm" id="n_receive<?= $i; ?>" name="n_receive[]" onkeypress="return bilanganasli(event);hitung();" onkeyup="cek(<?= $i; ?>);hitung();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                ...
                                <div class="form-actions">
                                    <button type="submit" id="submit" class="btn btn-warning round btn-min-width mr-1"><i class="icon-paper-plane mr-1"></i><?= $this->lang->line("Terima"); ?></button>
