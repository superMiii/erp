                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm" min="<?= get_min_date(); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->dnota; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" value="<?= $data->d_nota; ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <select class="form-control" name="i_supplier" id="i_supplier" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Nama Pemasok"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                        <option value="<?= $data->i_supplier; ?>" selected><?= $data->i_supplier_id . ' - ' . $data->e_supplier_name; ?></option>
                                                    </select>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control form-control-sm" value="<?= $data->i_nota_supplier; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="i_nota_supplier" name="i_nota_supplier" maxlength="500" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select data-nourut="<?= $i; ?>" required class="form-control select2-size-sm nota" name="i_nota[]" id="i_nota<?= $i; ?>">
                                                                    <option value="<?= $key->i_gr; ?>"><?= $key->i_gr_id; ?></option>
                                                                </select>
                                                            </td>
