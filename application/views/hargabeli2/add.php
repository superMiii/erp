                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select id="i_supplier" name="i_supplier" class="form-control" style="width: 100%" required data-placeholder="<?= $this->lang->line("Pilih"); ?> <?= $this->lang->line("Pemasok"); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div>
                                <!-- <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <select class="form-control" style="width: 100%" required data-placeholder="<?= $this->lang->line("Pilih"); ?> <?= $this->lang->line("Barang"); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" id="i_product" name="i_product">
                                            <option value=""></option>
                                        </select>
                                    </div>
                                </div> -->
                                <!--  <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control formatrupiah" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Kode Sub Kategori'); ?>" id="v_price" name="v_price" autocomplete="off" required autofocus>
                                    </div>
                                </div> -->
