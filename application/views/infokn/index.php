                            ...
                            <div class="table-responsive">
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            <th>No</th>
                                            <th><?= $this->lang->line('No. KN Retur'); ?></th>
                                            <th><?= $this->lang->line('Tgl. KN Retur'); ?></th>
                                            <th><?= $this->lang->line('No BBM'); ?></th>
                                            <th><?= $this->lang->line('Tgl BBM'); ?></th>
                                            ...
                                            <th><?= $this->lang->line('Nilai Sisa'); ?></th>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            <th class="text-right" colspan="9"><strong>TOTAL</strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($net, 0); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($sis, 0); ?></strong></th>
                                        </tr>
