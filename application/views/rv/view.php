                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="text" readonly class="form-control form-control-sm date" value="<?= $data->date_rv; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="row">
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly class="form-control form-control-sm" value="<?= $data->i_rv_type_id . ' - ' . $data->e_rv_type_name; ?>">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
