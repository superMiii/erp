                                    ...
                                    <div class="form-group row m-auto">
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_store" id="i_store" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Store"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Total Gabungan'); ?></th>
                                            <th><?= $this->lang->line('Alamat Pelanggan'); ?></th>
                                            <th><?= $this->lang->line('Kota'); ?></th>
                                            <th><?= $this->lang->line('Ekspedisi'); ?></th>
                                            <th><?= $this->lang->line('Alamat Ekspedisi'); ?></th>
                                            <th><?= $this->lang->line('Harga Ekspedisi'); ?></th>
                                            <th><?= $this->lang->line('Rasio'); ?></th>
                                            <th><?= $this->lang->line('No. Resi'); ?></th>
                                            <th><?= $this->lang->line('Via'); ?></th>
                                            <th><?= $this->lang->line('Alamat Exp. Via'); ?></th>
                                            <th><?= $this->lang->line('Ball'); ?></th>
