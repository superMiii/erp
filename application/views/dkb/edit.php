                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" class="form-control form-control-sm date" <?= konci(); ?> value="<?= $data->d_sl; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control form-control-sm text-capitalize" value="<?= $data->e_sopir_name; ?>" placeholder="<?= $this->lang->line('Nama Supir'); ?>" id="e_sopir_name" name="e_sopir_name" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" class="form-control form-control-sm text-uppercase" value="<?= $data->i_kendaraan; ?>" placeholder="<?= $this->lang->line('No Polisi'); ?>" maxlength="11" id="i_kendaraan" name="i_kendaraan" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" value="<?= $key->d_do; ?>" readonly class="form-control form-control-sm" id="d_do<?= $i; ?>" name="d_do[]" readonly></td>
                                                            <td><input type="text" value="<?= $key->e_customer_name; ?>" readonly class="form-control form-control-sm" id="e_customer_name<?= $i; ?>" readonly></td>
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <select data-nourut="<?= $ii; ?>" required class="form-control select2-size-sm" name="i_sl_ekspedisi[]" id="i_sl_ekspedisi<?= $ii; ?>">
                                                                    <option value="<?= $key->i_sl_ekspedisi; ?>"><?= '[ ' . $key->i_sl_ekspedisi_id . ' ] ' . $key->e_sl_ekspedisi; ?></option>
                                                                </select>
                                                            </td>
