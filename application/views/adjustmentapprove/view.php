...
<div class="content-body">
    ...
    <section id="pagination">
        <div class="row">
            <div class="col-12">
                <div class="card">
                    <div class="card-header header-elements-inline <?= $this->session->e_color; ?> text-white">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-12">
                                    <div class="form-group">
                                        ...
                                        <div class="controls">
                                            <input type="text" class="form-control form-control-sm" readonly value="<?= $data->e_remark; ?>" placeholder="" maxlength="500" autocomplete="off" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="card-body card-dashboard">
                            ...
                            <form action="<?= base_url($this->folder); ?>" method="post">
                                <div class="form-actions">
                                    ...
                                    <button type="button" onclick="sweetapprovev2('<?= $this->folder; ?>','<?= $data->i_adjustment; ?>');" class="btn btn-info round btn-min-width mr-1"><i class="fa fa-check-circle fa-lg mr-1"></i><?= $this->lang->line("Menyetujui"); ?></button>
