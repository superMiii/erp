                                ...
                                <div class="row"> 
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" readonly class="form-control round text-capitalize" value="<?= $data->d_berangkat; ?>" id="x" name="x"  autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                ...
                                <div class="row">                                    
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" readonly class="form-control round text-capitalize" value="<?= $data->i_dn_atasan; ?>" id="i_dn_atasan" name="i_dn_atasan"  autocomplete="off">
                                            </div>
                                        </div>
                                    </div>                                 
                                    <div class="col-md-4">
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="number" readonly value="<?= $data->n_biaya_vs_spb; ?>" onkeyup="vespa()" class="form-control form-control-sm text-capitalize" data-validation-number-message="<?= $this->lang->line('Number'); ?>" placeholder="%" id="n_biaya_vs_spb" name="n_biaya_vs_spb" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                ...
                                <div class="row"> 
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly value="<?= number_format($data->v_transfer); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_transfer" name="v_transfer" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly value="<?= number_format($data->v_tf1); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_tf1" name="v_tf1" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly value="<?= number_format($data->v_tf2); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_tf2" name="v_tf2" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly value="<?= number_format($data->v_tf3); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_tf3" name="v_tf3" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" readonly value="<?= number_format($data->v_tf4); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_tf4" name="v_tf4" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                </div>
