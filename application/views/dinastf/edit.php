                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header header-elements-inline <?= $this->session->e_color; ?> bg-darken-1 text-white">
                            <h4 class="card-title"><i class="icon-plus"></i> <?= $this->lang->line('Detail'); ?> <?= $this->lang->line($this->title); ?></h4>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        <div class="form-group">
                                            <label>Asal Keberangkatan : <span class="danger">*</span></label>
                                            <div class="controls">
                                            <input type="text" readonly class="form-control round text-capitalize" value="<?= $data->e_store_loc_name; ?>" id="i_store" name="i_store"  autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="row"> 
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                            <input type="text" readonly class="form-control round text-capitalize" value="<?= $data->e_staff_name; ?>" id="x" name="x"  autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input readonly id="d_berangkat" name="d_berangkat" type='date' value="<?= $data->d_berangkat; ?>" min="<?= date('Y-m-d'); ?>" class="form-control" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line('Tanggal Berangkat'); ?>" />
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                    ...
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input readonly id="d_kembali" name="d_kembali" type='date' value="<?= $data->d_kembali; ?>" min="<?= date('Y-m-d'); ?>" class="form-control" placeholder="<?= $this->lang->line('Tanggal Kembali'); ?>" />
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row"> 
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            <label class="font-medium-3" >Realisasi Biaya :</label>
                                            <div class="controls">
                                ...
                                <div class="row"> 
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="font-medium-3" ><?= $this->lang->line('Transfer'); ?> 1 : <span class="danger">*</span></label>
                                            <div class="controls">
                                                <input type="text" value="<?= number_format($data->v_transfer); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_transfer" name="v_transfer" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="font-medium-3" ><?= $this->lang->line('Transfer'); ?> 2 : <span class="danger">*</span></label>
                                            <div class="controls">
                                                <input type="text" value="<?= number_format($data->v_tf1); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_tf1" name="v_tf1" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="font-medium-3" ><?= $this->lang->line('Transfer'); ?> 3 : <span class="danger">*</span></label>
                                            <div class="controls">
                                                <input type="text" value="<?= number_format($data->v_tf2); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_tf2" name="v_tf2" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="font-medium-3" ><?= $this->lang->line('Transfer'); ?> 4 : <span class="danger">*</span></label>
                                            <div class="controls">
                                                <input type="text" value="<?= number_format($data->v_tf3); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_tf3" name="v_tf3" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            <label class="font-medium-3" ><?= $this->lang->line('Transfer'); ?> 5 : <span class="danger">*</span></label>
                                            <div class="controls">
                                                <input type="text" value="<?= number_format($data->v_tf4); ?>" class="form-control round text-capitalize formatrupiah" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Transfer'); ?>" id="v_tf4" name="v_tf4" autocomplete="off" maxlength="12" autofocus>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
