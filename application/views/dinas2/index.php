            ...
            <div class="col-12">
                <div class="card">
                    <div class="card-header header-elements-inline <?= $this->session->e_color; ?> bg-darken-1 text-white">
                        <h4 class="card-title"><i class="feather icon-list"></i> <?= $this->lang->line("Daftar"); ?> <?= $this->lang->line("Dinas"); ?> </h4>
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line("Acc1"); ?></th>
                                            <th><?= $this->lang->line("Acc2"); ?></th>
                                            <th><?= $this->lang->line("Acc3"); ?></th>
                                            <th><?= $this->lang->line("Acc4"); ?></th>
                                            <th><?= $this->lang->line("Acc5"); ?></th>
