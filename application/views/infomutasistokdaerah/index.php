                                        ...
                                        <div class="col-md-5">
                                            <div class="form-group">
                                                <div class="controls">
                                                    ...
                                                    <input type="hidden" value="<?= ($i_store); ?>" name="i_store2" id="i_store2">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-2">
                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th class="text-center"><?= $this->lang->line('Masuk'); ?></th>
                                            <th colspan="2" class="text-center"><?= $this->lang->line('Keluar'); ?></th>
                                        ...
                                        <tr>
                                            <th><?= $this->lang->line('Dari Pusat'); ?></th>
                                            <th><?= $this->lang->line('Penjualan'); ?></th>
                                            <th><?= $this->lang->line('Pengembalian'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                </table>
