                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <input type="hidden" name="nomor_segmen" value="<?= $data->i_pajak_id; ?>">
                                <input type="hidden" name="n_start" value="<?= $data->n_start; ?>">
                                <input type="hidden" name="n_end" value="<?= $data->n_end; ?>">
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label><?= $this->lang->line('Nomor Mulai'); ?> :</label>
                                            <div class="controls">
                                                <input type="text" class="form-control round text-uppercase" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Nomor Mulai'); ?>" id="nomor_mulai" name="nomor_mulai" autocomplete="off" value="<?= $data->nomor_mulai; ?>" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" class="form-control round text-uppercase" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Nomor Akhir'); ?>" id="nomor_akhir" name="nomor_akhir" autocomplete="off" readonly value="<?= $data->nomor_akhir; ?>">
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label><?= $this->lang->line("Nomor Nota Dari"); ?> :</label>
                                            <div class="controls">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            <label><?= $this->lang->line("Nomor Nota Sampai"); ?> :</label>
                                            <div class="controls">
