                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="formatrupiah form-control round text-capitalize" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Nomor Mulai'); ?>" id="n_start" name="n_start" onkeyup="formatrupiahkeyup(this);" onkeydown="formatrupiahkeydown(this);" autocomplete="off" value="<?= number_format($data->n_start, 0); ?>" required onblur="if(this.value==''){this.value='0';}" onfocus="if(this.value=='0'){this.value='';}">
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="formatrupiah form-control round text-capitalize" onkeyup="formatrupiahkeyup(this);" onkeydown="formatrupiahkeydown(this);" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Nomor Akhir'); ?>" id="n_end" name="n_end" autocomplete="off" value="<?= number_format($data->n_end, 0); ?>" required autofocus>
                                    </div>
                                </div>
