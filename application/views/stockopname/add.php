                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input type="date" class="form-control" min="<?= date('Y-m-d', strtotime("-30 day", strtotime(date('Y-m-d')))); ?>" max="<?= date('Y-m-d'); ?>" value="<?= date('Y-m-d'); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                                ...
                                                if ($prod->num_rows() > 0) {
                                                    foreach ($prod->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" value="0" name="n_stockopname[]" class="form-control form-control-sm " onblur="if(this.value=='' ){this.value='0' ;}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
