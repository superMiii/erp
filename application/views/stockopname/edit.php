                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input type="date" class="form-control" min="<?= date('Y-m-d', strtotime("-30 day", strtotime(date('Y-m-d')))); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_stockopname; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-8">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select class="form-control" readonly id="i_store_loc" name="i_store_loc" data-placeholder="<?= $this->lang->line("Pilih"); ?> <?= $this->lang->line("Lokasi Gudang"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                    <option value="<?= $data->i_store_loc; ?>"><?= $data->e_store_name . ' - ' . $data->e_store_loc_name; ?></option>
                                                </select>
                                            </div>
                                        </div>
                                    </div>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" value="<?= $key->n_stockopname; ?>" name="n_stockopname[]" class="form-control form-control-sm " onblur="if(this.value=='' ){this.value='0' ;}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
