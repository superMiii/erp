                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" readonly class="form-control form-control-sm date" min="2021-10-01" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_giro; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" readonly class="form-control form-control-sm date" min="2021-10-01" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_giro_duedate; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_giro_duedate" name="d_giro_duedate" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" readonly class="form-control form-control-sm date" min="2021-10-01" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_giro_terima; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_giro_terima" name="d_giro_terima" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" readonly class="form-control form-control-sm date" min="2021-10-01" value="<?= $data->d_giro_cair; ?>" max="<?= date('Y-m-d'); ?>" placeholder="mm/dd/yyyy" id="d_giro_cair" name="d_giro_cair" maxlength="500" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                <div class="input-group-prepend">
                                                    <div class="input-group-text">
                                                        <?php
                                                        $checked = ($data->f_giro_tolak == 't') ? 'checked' : '';
                                                        $readonly = ($data->f_giro_tolak == 't') ? '' : 'readonly';
                                                        ?>
                                                        <input disabled type="checkbox" <?= $checked; ?> id="ceklis" name="f_giro_tolak" aria-label="Checkbox for following text input">
                                                    </div>
                                                </div>
                                                <input type="date" <?= $readonly; ?> class="form-control form-control-sm date" min="2021-10-01" value="<?= $data->d_giro_tolak; ?>" max="<?= date('Y-m-d'); ?>" placeholder="mm/dd/yyyy" id="d_giro_tolak" name="d_giro_tolak" maxlength="500" autocomplete="off">
                                            </div>
                                        </div>
                                    </div>
                                </div>
