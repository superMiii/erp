                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm date" min="2021-10-01" value="<?= $data->d_giro_cair; ?>" max="<?= date('Y-m-d'); ?>" placeholder="mm/dd/yyyy" id="d_giro_cair" name="d_giro_cair" maxlength="500" autocomplete="off">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    <div class="input-group-prepend">
                                                        <div class="input-group-text">
                                                            ...
                                                            ?>
                                                            <input type="checkbox" <?= $checked; ?> id="ceklis" name="f_giro_tolak" aria-label="Checkbox for following text input">
                                                        </div>
                                                    </div>
