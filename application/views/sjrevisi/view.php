                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea readonly type="text" rows="3" class="form-control form-control-sm" placeholder="<?= $this->lang->line("Keterangan"); ?>" name="e_remark"><?= $data->remark2; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                <input type="text" readonly value="<?= $key->n_do; ?>" autocomplete="off" class="form-control text-right n_order form-control-sm" id="n_deliver<?= $i; ?>" name="n_deliver[]" onkeypress="return bilanganasli(event);cek(<?= $i; ?>);" onkeyup="cek(<?= $i; ?>)" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}">
