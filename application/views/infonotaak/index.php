                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Nilai Bersih'); ?></th>
                                    ...
                                    <tfoot>
                                        ...
                                        if ($data->num_rows() > 0) {
                                            foreach ($data->result() as $key) {
                                                $v_nota_gross       += $key->v_nota_gross;
                                                $v_nota_ppn         += $key->v_nota_ppn;
                                                $v_nota_discount    += $key->v_nota_discount;
                                                $v_nota_netto       += $key->v_nota_netto;
                                        ?>
                                        <?php }
                                        } ?>
                                        <tr>
                                            <th class="text-right" colspan="11"><strong>TOTAL</strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($v_nota_gross, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($v_nota_ppn, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($v_nota_discount, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($v_nota_netto, 2); ?></strong></th>
                                        </tr>
