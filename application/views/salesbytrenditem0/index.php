                                ...
                                <table class="table table-xs display nowrap text-uppercase table-striped table-bordered font-small-3" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th class="text-center" rowspan="2"><?= $this->lang->line('Kode'); ?><br><?= $this->lang->line('Barang'); ?></th>
                                    ...
                                    ?>
                                    <tbody class="font-small-1 text-capitalize">
                                        <?php
                                        if ($data) {
                                            $grwoa = 0;
                                            $grwqty = 0;
                                    ...
                                    <tfoot>
                                        <tr>
                                            <th class="text-center" colspan="5"><b>Total</b></td>
