                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="text" name="i_document" id="i_document" readonly placeholder="ADJ-<?= date('ym'); ?>-000001" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
                                    <div class="col-md-2">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm">
                                                ...
                                                <input type="date" class="form-control form-control-sm" min="<?= date('Y-m-01'); ?>" max=<?= date('Y-m-d'); ?> value="<?= tx_tgl(); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <select class="form-control form-control-sm" id="i_store_loc" name="i_store_loc" data-placeholder="<?= $this->lang->line("Pilih"); ?> <?= $this->lang->line("Lokasi Gudang"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                    <option value=""></option>
                                                </select>
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea type="text" required name="e_remark0" class="form-control" placeholder="<?= $this->lang->line("Keterangan"); ?>"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
