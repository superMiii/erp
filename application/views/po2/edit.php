                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" <?= koncix(); ?> class="form-control form-control-sm" min="<?= date('Y-m-d', strtotime("-30 day", strtotime(date('Y-m-d')))); ?>" max="<?= date('Y-m-d'); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" value="<?= $data->d_po; ?>" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea class="form-control text-capitalize" placeholder="<?= $this->lang->line('Remark'); ?>" id="e_po_remark" name="e_po_remark" autocomplete="off"><?= $data->e_po_remark; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="text" autocomplete="off" class="form-control text-right v_product_mill form-control-sm" id="v_product_mill<?= $i; ?>" name="v_product_mill[]" value="<?= number_format($key->v_product_mill); ?>"  onkeypress="return bilanganasli(event);hetang();" onkeyup="hetang();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                            <td><input type="text" autocomplete="off" class="form-control text-right n_order form-control-sm" id="n_order<?= $i; ?>" value="<?= $key->n_order; ?>" name="n_order[]" onkeypress="return bilanganasli(event);hetang();" onkeyup="hetang();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
