                                ...
                                <div class="row">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="hidden" name="id" id="id" readonly value="<?= $data->i_po; ?>">
                                                    <input type="hidden" name="i_document_old" id="i_document_old" readonly value="<?= $data->i_po_id; ?>">
                                                    <input type="text" name="i_document" id="i_document" readonly value="<?= $data->i_po_id; ?>"  placeholder="PO-<?= date('ym'); ?>-000001" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" <?= konci(); ?> class="form-control form-control-sm" min="<?= date('Y-m-d', strtotime("-30 day", strtotime(date('Y-m-d')))); ?>" max="<?= date('Y-m-d'); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" value="<?= $data->d_po; ?>" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">                                                
                                            <input type="text" class="form-control clear form-control-sm text-capitalize" name="i_supplier" id="i_supplier" readonly value="<?= $data->e_supplier_name; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control clear form-control-sm text-capitalize" name="e_po_remark" id="e_po_remark" readonly value="<?= $data->e_po_remark; ?>">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>                                                                
                                                            <input type="text" class="form-control form-control-sm" id="i_product<?= $i; ?>" name="i_product[]" value="<?= $key->i_product_id . ' - ' . $key->e_product_name; ?>" readonly>                                                                
                                                            </td>
                                                            <td>
                                                            <input type="hidden" name="i_product_motif[]" id="i_product_motif<?= $i; ?>" value="<?= $key->i_product_grade; ?>">
                                                            <input type="hidden" name="i_product_grade[]" id="i_product_grade<?= $i; ?>" value="<?= $key->i_product_motif; ?>">            
                                                            <input type="hidden" name="e_product_name[]" id="e_product_name<?= $i; ?>" value="<?= $key->e_product_name; ?>">  
                                                            <input type="text" class="form-control text-right form-control-sm" id="e_product_motifname<?= $i; ?>" name="e_product_motifname[]" value="<?= $key->e_product_motifname; ?>" readonly>
                                                            </td>                                                            
                                                            <td>                                                                
                                                            <input type="text" class="form-control text-right form-control-sm" id="v_product_mill<?= $i; ?>" name="v_product_mill[]" value="<?= $key->v_product_mill; ?>" readonly>                                                                
                                                            </td>
                                                            <td>                                                                
                                                            <input type="text" class="form-control text-right form-control-sm" id="n_order<?= $i; ?>" name="n_order[]" value="<?= $key->n_order; ?>" readonly>                                                                
                                                            </td>
