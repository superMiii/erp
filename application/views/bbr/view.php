                                ...
                                <div class="row">
                                    ...
                                    <div class="col-sm-4">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" <?= konci(); ?> class="form-control form-control-sm" min="<?= date('Y-m-d', strtotime("-30 day", strtotime(date('Y-m-d')))); ?>" max="<?= date('Y-m-d'); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" value="<?= $data->d_bbr; ?>" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="form-control form-control-sm text-uppercase" readonly value="<?= $data->e_supplier_name; ?>">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                    <input type="text" class="form-control form-control-sm text-uppercase" readonly value="<?= $data->e_po_remark; ?>">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" readonly autocomplete="off" class="form-control text-right n_order form-control-sm" id="n_order<?= $i; ?>" value="<?= $key->n_quantity; ?>" name="n_order[]" onkeypress="return bilanganasli(event);hetang();" onkeyup="hetang();miru(<?= $i; ?>);" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
