        ...
        <div class="row">
            <div class="col-md-12 col-12 printable-content">
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <!-- card-header -->
                        <input type="hidden" id="id" value="<?= $data->i_bbr; ?>">

                        <!-- invoice logo and title -->
                        <div class="invoice-logo-title row">
                            <div class="col-9 d-flex flex-column justify-content-center align-items-start">
                                <!-- <span>Software Development</span> -->
                                <p class="font-large-2 text-uppercase text-primary">RETUR PEMBELIAN<br><span class="font-medium-3 font-weight-bold">NOMOR RETUR : <?= $data->i_bbr_id; ?></span></p>
                            </div>
                        ...
                        <div class="row invoice-adress-info px-0">
                            ...
                            <div class="col-6 mt-1 to-info text-right">
                                <div class="company-name mb-1">
                                    <span class="font-medium-3">Tanggal Retur : <?= $data->d_bbr; ?></span><br>
                        ...
                        <div class="product-details-table table-responsive">
                            <table class="table table-xs table-bordered mt-0 mb-0">
                                ...
                                <tbody>
                                    ...
                                    ?>
                                            ...
                                            <td width="25%" valign="center"><?= $key->i_product_id . ' - ' . $key->e_product_name; ?></td>
                                            <td class="text-right" width="15%" valign="center"><?= number_format($key->v_unit_price); ?></td>
                                            <td class="text-center" width="5%" valign="center"><?= $key->st; ?></td>
                                            <td class="text-center" width="5%" valign="center"><?= $key->n_quantity; ?></td>
                                            <?php $miru += ($key->v_unit_price * $key->n_quantity) ; ?>
                                            <td class="text-right" width="20%" valign="center"><?= number_format($miru); ?></td>
                                            <td width="30%" valign="center"><?= $key->ket; ?></td>
                                            </tr>
                                    <?php
                                            $totalll += ($miru) ;
                                        }
                                ...
                                <tfoot>
                                    ...
                                    <tr>
                                        <th class="text-right" colspan="6"><span class="font-medium-3 text-capitalize"><em>(<?= terbilang($totalll); ?>)</em></span></th>
                                    </tr>
                            ...
                            <div class="invoice-total mt-0 mb-0">
                                <div class="row">
                                    ...
                                    <div class="col-sm-12 text-right">
                                        <span class="font-medium-3"><strong>Bandung, <?= date('d', strtotime($data->d_bbr)) . ' ' . bulan(date('m', strtotime($data->d_bbr))) . ' ' . date('Y', strtotime($data->d_bbr)); ?></strong></span>
                                    </div><br>
                                    <div class="col-sm-12">
