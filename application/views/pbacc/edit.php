                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input type="date" class="form-control date" <?= konci(); ?> value="<?= $data->d_gs; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea autofocus class="form-control" placeholder="<?= $this->lang->line('Alasan Setuju'); ?>" id="e_note" name="e_note" value=""></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-actions">
                                    <button type="submit" class="btn btn-info round btn-min-width mr-1"><i class="fa fa-check-circle fa-lg mr-1"></i><?= $this->lang->line("Menyetujui"); ?></button>
                                </div>
                                <!-- <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" value="<?= $key->n_quantity_order; ?>" readonly name="n_order[]" id="n_order<?= $i; ?>" class="form-control form-control-sm" onblur="if(this.value=='' ){this.value='0' ;}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                            <td><input type="number" value="<?= $key->n_quantity_order; ?>" name="n_acc[]" id="n_acc<?= $i; ?>" class="form-control form-control-sm" onkeyup="hetang(<?= $i; ?>);"></td>
