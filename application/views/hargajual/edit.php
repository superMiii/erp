                            ...
                            <form class="form-validation" novalidate>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        ...
                                        <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line('Required'); ?>" placeholder="<?= $this->lang->line('Masukan'); ?> <?= $this->lang->line('Kode Pemasok'); ?>" id="kode" name="kode" maxlength="30" autocomplete="off" value="<?= $data->i_supplier_id; ?>" required autofocus>
                                    </div>
                                </div>
