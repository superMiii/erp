                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th rowspan="2"><?= $this->lang->line('Target'); ?></th>
                                            <th colspan="4" class="text-center"><?= $this->lang->line('Keuangan'); ?></th>
                                            <th colspan="4" class="text-center"><?= $this->lang->line('Penjualan'); ?></th>
                                        </tr>
                                        <tr>
                                            <th><?= $this->lang->line('SPB'); ?></th>
                                            <th><?= $this->lang->line('Persentase SPB'); ?></th>
                                            <th><?= $this->lang->line('Nota'); ?></th>
                                            <th><?= $this->lang->line('Persentase Nota'); ?></th>
                                            <th><?= $this->lang->line('SPB'); ?></th>
                                            <th><?= $this->lang->line('Persentase SPB'); ?></th>
                                            <th><?= $this->lang->line('Nota'); ?></th>
                                            <th><?= $this->lang->line('Persentase Nota'); ?></th>
                                    ...
                                    <tfoot>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right"><strong>Rp. <?= number_format($spb, 2); ?></strong></th>
                                            <th class="text-right"><?= number_format($persen1); ?> %</th>
                                            <th class="text-right"><strong>Rp. <?= number_format($nota, 2); ?></strong></th>
                                            <th class="text-right"><?= number_format($persen2); ?> %</th>
                                            <th class="text-right"><strong>Rp. <?= number_format($spb1, 2); ?></strong></th>
                                            <th class="text-right"><?= number_format($persen11); ?> %</th>
                                            <th class="text-right"><strong>Rp. <?= number_format($nota1, 2); ?></strong></th>
                                            <th class="text-right"><?= number_format($persen21); ?> %</th>
                                        </tr>
