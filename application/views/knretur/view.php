                                            ...
                                            <div class="form-group">
                                                ...
                                                <fieldset>
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="text" name="i_document" id="i_document" readonly value="<?= $data->i_kn_id; ?>" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" readonly class="form-control form-control-sm date" min="<?= date('Y-m-01'); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_kn; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-sm-3">
                                    ...
                                    <div class="row">
                                                ...
                                                <div class="controls">
                                                    <fieldset>
                                                        <div class="float-left">
                                                            <input type="checkbox" readonly <?php if ($data->f_masalah == 't') {
                                                                                                echo "checked";
                                        ...
                                        <div class="col-md-8">
                                            <div class="form-group">
                                                ...
                                                <textarea readonly required class="form-control text-capitalize" placeholder="<?= $this->lang->line('Keterangan'); ?>" id="e_remark" name="e_remark"><?= $data->e_remark; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <?php } ?>
                                                            <td><input type="text" class="form-control form-control-sm" name="e_ttb_remark[]" value="TTB Retur" readonly></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
