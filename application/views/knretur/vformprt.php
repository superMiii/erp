...
@page
    ...
    <table width="100%" class="nmper" border="0">
        ...
        <tr>
            <td colspan="3">No. : <?php echo $data->i_kn_id; ?></td>
            <td><?php echo $data->i_customer . "-" . $data->e_customer_name; ?></td>
        </tr>
        <tr>
            <td colspan="3">KS. : <?php echo $data->i_salesman . "  " . $data->e_salesman_name; ?></td>
            <td><?php echo $data->e_customer_address . " " . $data->e_city_name; ?></td>
        </tr>
        <tr>
            <td colspan="4">&nbsp;</td>
        </tr>
    ...
    foreach ($bbm->result() as $rowbbm) { ?>
        <table width="100%" class="nmper" border="0">
            ...
            <tr>
                <td colspan="2">Referensi &nbsp;&nbsp; : <?php echo $data->i_kn_id; ?></td>
            </tr>
            <tr>
