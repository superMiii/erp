                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" <?= koncix(); ?> class="form-control form-control-sm date" min="<?= get_min_date(); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_bukti; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <fieldset>
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="hidden" readonly name="i_pv" id="i_pv" value="<?= $data->i_pv; ?>">
                                                        <input type="hidden" readonly name="i_pv_item" id="i_pv_item" value="<?= $data->i_pv_item; ?>">
                                                        <input type="text" readonly name="i_pv_id" id="i_pv_id" value="<?= $data->i_pv_id; ?>" class="form-control form-control-sm text-uppercase">
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <input type="text" readonly name="v_jumlah" id="vjumlah" class="form-control form-control-sm" value="<?= number_format($data->v_pv_saldo); ?>">
                                                <input type="hidden" id="vlebih" name="v_lebih" value="0">
                                                <input type="hidden" id="vsisa" name="vsisa" value="<?= $data->v_pv_saldo; ?>">
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?= base_url($this->folder . '/indexx/' . encrypt_url($dfrom) . '/' . encrypt_url($dto)); ?>" class="btn btn-secondary round btn-min-width mr-1"><i class="icon-action-undo mr-1"></i><?= $this->lang->line("Kembali"); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
