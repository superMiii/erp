                                            ...
                                            <div class="col-md-6">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_product_status" id="i_product_status" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Pemasok"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                            <option value="<?= $i_product_status; ?>"><?= $e_product_statusname; ?></option>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                            </div>
