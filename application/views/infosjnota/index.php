                                ...
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            ...
                                            <th><?= $this->lang->line('Nilai Kotor'); ?></th>
                                            <th><?= $this->lang->line('PPN'); ?></th>
                                            <th><?= $this->lang->line('Diskon'); ?></th>
                                            <th><?= $this->lang->line('Total Nota'); ?></th>
                                    ...
                                    <tfoot>
                                        ...
                                        if ($data->num_rows() > 0) {
                                            foreach ($data->result() as $key) {
                                                $do += $key->v_do;
                                                $nota_gross += $key->v_nota_gross;
                                                $nota_ppn += $key->v_nota_ppn;
                                                $nota_discount += $key->v_nota_discount;
                                                $nota_netto += $key->v_nota_netto;
                                                $sisa += $key->v_sisa;
                                        ?>
                                        <?php }
                                        }
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-right"><strong>Rp. <?= number_format($do, 2); ?></strong></th>
                                            <th class="text-right"></th>
                                            <th class="text-right"></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($nota_gross, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($nota_ppn, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($nota_discount, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($nota_netto, 2); ?></strong></th>
                                            <th class="text-right"><strong>Rp. <?= number_format($sisa, 2); ?></strong></th>
                                        </tr>
