                                                    ...
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="number" value="<?= $key->n_do; ?>" class="form-control text-center n_order form-control-sm" id="n_deliver<?= $i; ?>" name="n_deliver[]" onkeyup="cek(<?= $i; ?>);" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}">
