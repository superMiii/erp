                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <?php if ($data->i_customer == '37' or $data->i_customer == '3358') { ?>
                                                    <input type="date" class="form-control form-control-sm" min="<?= date('Y-m-d'); ?>" max="<?= date('Y-m-d', strtotime("+2 day", strtotime(date('Y-m-d')))); ?>" value="<?= tx_tgl(); ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                ...
                                                <?php } elseif ($data->i_company == '8') { ?>
                                                    <!-- <input type="date" class="form-control form-control-sm" value="<?= tx_tgl(); ?>" <?= konci(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required> -->
                                                    <input type="date" class="form-control form-control-sm" value="<?= tx_tgl(); ?>" max="<?= date('Y-m-d'); ?>" min="<?= date('Y-m-d', strtotime("-2 day", strtotime(date('Y-m-d')))); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                <?php } else { ?>
                                                    <input type="date" class="form-control form-control-sm" value="<?= tx_tgl(); ?>" <?= konci(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                    <!-- <input type="date" class="form-control form-control-sm" value="2023-07-31" readonly placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required> -->
                                                <?php } ?>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" value="<?= $n_sj;  ?>" class="form-control text-center n_order form-control-sm" id="n_deliver<?= $i; ?>" name="n_deliver[]"  onkeyup="cek(<?= $i; ?>)" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
