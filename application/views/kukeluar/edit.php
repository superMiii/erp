                                            ...
                                            <div class="form-group">
                                                ...
                                                <fieldset>
                                                    <div class="input-group input-group-sm">
                                                        ...
                                                        <input type="hidden" name="id" id="id" placeholder="No Transfer" value="<?= $data->i_kuk; ?>">
                                                        <input type="hidden" name="i_document_old" id="i_document_old" value="<?= $data->i_kuk_id; ?>">
                                                        <input type="text" name="i_document" id="i_document" value="<?= $data->i_kuk_id; ?>" <?= konci(); ?> placeholder="TK-<?= date('ym'); ?>-000001" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                    </div>
                                        ...
                                        <div class="col-md-3">
                                            <div class="form-group">
                                                ...
                                                <div class="input-group input-group-sm controls">
                                                    ...
                                                    <input type="date" class="form-control form-control-sm date" min="<?= get_min_date2(); ?>" max="<?= date('Y-m-d'); ?>" value="<?= $data->d_kuk; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-md-5">
