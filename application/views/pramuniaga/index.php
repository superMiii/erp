    ...
    <div class="content-header-left col-md-12 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="breadcrumb-wrapper col-12">
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="#" onclick="return false;"><?= $this->lang->line("Master"); ?></a>
                    <li class="breadcrumb-item"><a href="#" onclick="return false;"><?= $this->lang->line($this->title); ?></a>
                    </li>
                            ...
                            <div class="table-responsive">
                                <table class="table table-sm display nowrap table-striped table-bordered" id="serverside">
                                    <thead class="<?= $this->session->e_color;?> bg-darken-1 text-white">
                                        <tr>
                                            <th>No</th>
                                            <th><?= $this->lang->line("Kode Pramuniaga"); ?></th>
