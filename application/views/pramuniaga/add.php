                        ...
                        <div class="card-body card-dashboard">
                            <form class="form-validation" novalidate>
                                <div class="form-group">
                                    ...
                                    <div class="controls">
                                        <input type="text" class="form-control round text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line("Kode Pramuniaga"); ?>" id="i_salesman_id" name="i_salesman_id" maxlength="100" autocomplete="off" required autofocus>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label><?= $this->lang->line("Nama Pramuniaga"); ?> :</label>
                                    <div class="controls">
                                        <input type="text" class="form-control round text-capitalize" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="<?= $this->lang->line("Nama Pramuniaga"); ?>" id="e_salesman_name" name="e_salesman_name" maxlength="500" autocomplete="off" required>
                                    </div>
                                </div>
