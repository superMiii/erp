                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                                    ...
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                ...
                                                                <input type="hidden" value="<?= $key->n_deliver; ?>" id="n_stock<?= $i; ?>" name="n_stock[]" readonly>
                                                            </td>
                                                            <td><input type="text" value="<?= $key->n_do; ?>" autocomplete="off" class="form-control text-right n_order form-control-sm" id="n_deliver<?= $i; ?>" name="n_deliver[]" onkeypress="return bilanganasli(event);hitung();" onkeyup="hitung()" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
                                ...
                                <div class="form-actions">
                                    <button type="submit" id="submit" class="btn btn-success btn-min-width"><i class="icon-paper-plane mr-1"></i><?= $this->lang->line("Ubah"); ?></button>
