                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" class="form-control form-control-sm" max="<?= date('Y-m-d'); ?>" value="<?= tx_tgl(); ?>" <?= konci(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                                <!-- <input type="date" class="form-control form-control-sm" value="2023-07-31" readonly placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required> -->
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" readonly class="form-control form-control-sm" value="<?= $data->d_sr; ?>" <?= koncix(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_sr" name="d_sr" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center" valign="center"><?= $this->lang->line("Jml Acc"); ?></th>
                                                    <th class="text-center" valign="center"><?= $this->lang->line("Jml Stok"); ?></th>
                                                    <th class="text-center" width="15%;" valign="center"><?= $this->lang->line("Jml Kirim"); ?></th>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-right">
                                                                <?= number_format($key->n_acc - $key->n_deliver); ?>
                                                                <input type="hidden" value="<?= $key->n_acc - $key->n_deliver; ?>" id="n_order<?= $i; ?>" name="n_order[]" readonly>
                                                            </td>
                                                            <td class="text-right">
                                                            ...
                                                            <?php
                                                            $total_order = ($key->n_acc - $key->n_deliver);
                                                            $stok = $key->stok;
                                                            $n_sj = 0;
                                                            if ($stok >= $total_order) {
                                                                $n_sj = $total_order;
                                                            ...
                                                            $total_rupiah += $n_sj *  $key->v_unit_price;
                                                            ?>
                                                            <!-- <td><input type="text" value="<?= $n_sj;  ?>" autocomplete="off" class="form-control text-right n_order form-control-sm" id="n_deliver<?= $i; ?>" name="n_deliver[]" onkeypress="return bilanganasli(event);hitung();" onkeyup="cek(<?= $i; ?>);hitung();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td> -->
                                                            <td><input type="text" value="0" autocomplete="off" class="form-control text-right n_order form-control-sm" id="n_deliver<?= $i; ?>" name="n_deliver[]" onkeypress="return bilanganasli(event);hitung();" onkeyup="cek(<?= $i; ?>);hitung();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>

                                                            <td><input type="text" value="<?= $key->e_remark; ?>" autocomplete="off" class="form-control form-control-sm text-left" id="e_remark<?= $i; ?>" name="e_remark[]"></td>
                                                        </tr>
                                                <?php }
                                                } ?>
                                            </tbody>
