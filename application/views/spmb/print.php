...
<body>
    <table width="100%" border="0" cellpadding="0" cellspacing="0">
        ...
        <tr>
            ...
            <td width="50%" class="text-center"><span class="header text-bold-700"><?= $this->lang->line('Surat Permintaan Barang'); ?></span></td>
        </tr>
        <tr>
            <td><span class="font-12 text-capitalize">Bagian Pembelian</span></td>
        ...
        <tr>
            <td colspan="2"><span class="font-12">Bersama surat ini kami mohon dikirimkan barang-barang sebagai berikut :</span></td>
        </tr>
    </table>
    ...
    <table class="font-12" width="100%" border="1" cellspacing="0" cellpadding="2">
        <thead>
            <tr>
                ...
                <th class="text-right" scope="col"><?= $this->lang->line("Jml Pesan"); ?></th>
        ...
        <tbody>
            ...
            ?>
                    <tr>
                        ...
                        <td class="text-right"><?= $key->n_acc; ?></td>
