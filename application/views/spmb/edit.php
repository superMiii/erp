                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group controls">
                                                ...
                                                <input type="date" <?= konci(); ?> min="<?= get_min_date(); ?>" max="<?= date('Y-m-d'); ?>" class="form-control date" value="<?= $data->d_sr; ?>" data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_document" name="d_document" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-md-5">
                                ...
                                <div class="row">
                                    <div class="col-sm-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <input type="text" name="e_remark" id="e_remark" class="form-control" placeholder="<?= $this->lang->line("Keterangan :"); ?>" value="<?= $data->e_remark; ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                ...
                                                if ($detail->num_rows() > 0) {
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><input type="number" value="<?= $key->n_order; ?>" name="n_order[]" id="n_order<?= $i; ?>" class="form-control n_order form-control-sm" onkeypress="return bilanganasli(event);raya();" onkeyup="raya();" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                            <td><input type="number" value="<?= $key->n_acc; ?>" readonly name="n_acc[]" id="n_acc<?= $i; ?>" class="form-control form-control-sm"></td>
