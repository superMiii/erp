                                    ...
                                    <div class="form-group row m-auto">
                                        <div class="col-md-12 row m-auto">
                                            ...
                                            <div class="col-md-2">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_price_group" id="i_price_group" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("-"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                            <option value="<?= $i_price_group; ?>"><?= $e_price_groupname; ?></option>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_customer_status" id="i_customer_status" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("-"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                            <option value="<?= $i_customer_status; ?>"><?= $e_customer_statusname; ?></option>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-2">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <select class="form-control" name="i_customer_group" id="i_customer_group" data-placeholder="<?= $this->lang->line("Pilih") . ' ' . $this->lang->line("Kelompok Pelanggan"); ?>" required data-validation-required-message="<?= $this->lang->line("Required"); ?>">
                                                            <option value="<?= $i_customer_group; ?>"><?= $e_customer_groupname; ?></option>
                                                        </select>
                                                    </div>
                                                </fieldset>
                                            </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            <th>No</th>
                                            <th><?= $this->lang->line('Tanggal Terdaftar'); ?></th>
                                            ...
                                            <th><?= $this->lang->line('Kelompok Pelanggan'); ?></th>
                                            <th><?= $this->lang->line('PPN'); ?></th>
                                            <th><?= $this->lang->line('Kode NPWP'); ?></th>
                                            <th><?= $this->lang->line('Nama Pemilik'); ?></th>
                                            <th><?= $this->lang->line('Nomor KTP Pemilik'); ?></th>
                                            <th><?= $this->lang->line('Nomor Telepon'); ?></th>
                                            <th><?= $this->lang->line('Diskon1'); ?></th>
                                            <th><?= $this->lang->line('Diskon2'); ?></th>
                                            <th><?= $this->lang->line('Diskon3'); ?></th>
                                            <th><?= $this->lang->line('Tipe Pelanggan'); ?></th>
                                            <th><?= $this->lang->line('Status Pelanggan'); ?></th>
                                            <th><?= $this->lang->line('Kelompok Harga'); ?></th>
                                            <th><?= $this->lang->line('TOP'); ?></th>
                                            <th><?= $this->lang->line('Plafon'); ?></th>
                                        </tr>
                                    </thead>
                                    <tbody></tbody>
                                </table>
