            ...
            <div class="row breadcrumbs-top">
                <div class="breadcrumb-wrapper col-12">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="<?= base_url($this->folder . '/index/' . encrypt_url($dfrom) . '/' . encrypt_url($dto) . '/' . encrypt_url($i_area)); ?>"><?= $this->lang->line($this->title); ?></a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url($this->folder . '/indexx/' . encrypt_url($dfrom) . '/' . encrypt_url($dto) . '/' . encrypt_url($i_area)); ?>"><?= $this->lang->line('Surat Jalan'); ?></a></li>
                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-header header-elements-inline <?= $this->session->e_color; ?> bg-darken-1 text-white">
                            ...
                            <input type="hidden" id="harea" value="<?= encrypt_url($i_area); ?>">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <fieldset>
                                                <div class="input-group input-group-sm">
                                                    ...
                                                    <input type="text" name="i_document" id="i_document" readonly placeholder="FP-<?= date('ym'); ?>-000001" value="<?= $data->i_do_id; ?>" class="form-control form-control-sm text-uppercase" data-validation-required-message="<?= $this->lang->line("Required"); ?>" maxlength="500" autocomplete="off" required aria-label="Text input with checkbox">
                                                </div>
                                            </fieldset>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" class="form-control form-control-sm" value="<?= $data->d_do; ?>" <?= konci(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="d_nota" name="d_nota" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-5">
                                    ...
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="date" class="form-control form-control-sm" value="<?= date('Y-m-d', strtotime($data->d_do)); ?>" <?= konci(); ?> data-validation-required-message="<?= $this->lang->line("Required"); ?>" placeholder="" id="tanggal_do" name="tanggal_do" maxlength="500" autocomplete="off" required>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-sm-3">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                ...
                                                <input type="hidden" name="f_so_stockdaerah" id="f_so_stockdaerah" class="form-control" value="<?= $data->f_so_stockdaerah; ?>">
                                            ...
                                            <div class="controls">
                                                <fieldset>
                                                    <div class="float-left">
                                                        <input readonly type="checkbox" id="f_masalah" name="f_masalah" class="switch" data-group-cls="btn-group-sm" data-on-label="<?= $this->lang->line('Ya'); ?>" data-off-label="<?= $this->lang->line('Tidak'); ?>" data-switch-always />
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea type="text" rows="3" class="form-control form-control-sm" placeholder="<?= $this->lang->line("Keterangan"); ?>" name="e_remark"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="card-content collapse show">
                            <div class="card-body card-dashboard">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr class="align-baseline">
                                                            ...
                                                            <td class="text-right"><?= $key->n_so_discount1; ?></td>
                                                            <td class="text-right"><?= $key->n_so_discount2; ?></td>
                                                            <td class="text-right"><?= $key->n_so_discount3; ?></td>
                                                            <td class="text-right"><?= number_format($total); ?></td>
                                                            <input type="hidden" name="i_do[]" id="i_do<?= $i; ?>"" value=" <?= $key->i_do; ?>">
                                                            <input type="hidden" name="d_do[]" id="d_do<?= $i; ?>"" value=" <?= $key->tanggal_do; ?>">
                                                            ...
                                                            <input type="hidden" name="n_nota_discount1[]" id="n_nota_discount1<?= $i; ?>"" value=" <?= $key->n_so_discount1; ?>">
                                                            <input type="hidden" name="v_nota_discount1[]" id="v_nota_discount1<?= $i; ?>"" value=" <?= $v_diskon1; ?>">
                                                            <input type="hidden" name="n_nota_discount2[]" id="n_nota_discount2<?= $i; ?>"" value=" <?= $key->n_so_discount2; ?>">
                                                            <input type="hidden" name="v_nota_discount2[]" id="v_nota_discount2<?= $i; ?>"" value=" <?= $v_diskon2; ?>">
                                                            <input type="hidden" name="n_nota_discount3[]" id="n_nota_discount3<?= $i; ?>"" value=" <?= $key->n_so_discount3; ?>">
                                                            <input type="hidden" name="v_nota_discount3[]" id="v_nota_discount3<?= $i; ?>"" value=" <?= $v_diskon3; ?>">
                                                            <input type="hidden" name="n_nota_discount4[]" id="n_nota_discount4<?= $i; ?>"" value=" <?= $key->n_so_discount4; ?>">
                                                            <input type="hidden" name="v_nota_discount4[]" id="v_nota_discount4<?= $i; ?>"" value=" <?= $key->v_so_discount4; ?>">
                                                        </tr>
                                                <?php
                                                        $subtotal += $total;
                                ...
                                <div class="form-actions">
                                    ...
                                    <a href="<?= base_url($this->folder . '/indexx/' . encrypt_url($dfrom) . '/' . encrypt_url($dto) . '/' . encrypt_url($i_area)); ?>" class="btn btn-secondary round btn-min-width mr-1"><i class="icon-action-undo mr-1"></i><?= $this->lang->line("Kembali"); ?></a>
                                </div>
                            </div>
                        </div>
                    </div>
