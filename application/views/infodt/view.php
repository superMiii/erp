                ...
                <div class="card">
                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                            ...
                            <h5 class="text-center text-bold-600 mb-0">No. DT : <?= $i_dt_id; ?></h5>
                            ...
                            <div class="table-responsive">
                                <table class="table table-xs display nowrap table-striped table-bordered" id="serverside2" width="100%;">
                                    <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                        <tr>
                                            <th>No</th>
                                            <th><?= $this->lang->line('Daftar Tagihan'); ?></th>
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    ...
                                                    <td><?= $key->i_nota_id; ?></td>
                                                    <td><?= $key->d_nota; ?></td>
                                                    <td><?= $key->d_jatuh_tempo; ?></td>
                                                    <td class="text-right"><?= $key->nm; ?></td>
                                                    <td class="text-right">Rp. <?= number_format($key->v_nota_netto); ?></td>
                                                    <td class="text-right">Rp. <?= number_format($key->v_sisa); ?></td>
                                                    <td class="text-right">Rp. <?= number_format($key->v_jumlah); ?></td>
                                                    <td><?= $key->e_rv_refference_type_name; ?></td>
                                                    <td><?= $key->e_remark; ?></td>
                                                </tr>
                                        <?php }
                                        } ?>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-right">Rp. <?= number_format($d); ?></th>
                                            <th class="text-right">Rp. <?= number_format($e); ?></th>
                                            <th class="text-right">Rp. <?= number_format($f); ?></th>
                                        </tr>
                                    </tfoot>
                                </table>
                            </div>
