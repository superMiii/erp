                    ...
                    <div class="card-content collapse show">
                        <div class="card-body card-dashboard">
                                        ...
                                        <div class="col-md-12 row m-auto">
                                                ...
                                                <fieldset>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <button class="btn btn-secondary" type="button"><i class="feather icon-calendar"></i></button>
                                                        </div>
                                            ...
                                            <div class="col-md-3">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <div class="input-group-prepend">
                                                            <button class="btn btn-secondary" required type="button"><i class="feather icon-calendar"></i></button>
                                                        </div>
                                            ...
                                            <div class="col-md-4">
                                                <fieldset>
                                                    <div class="input-group input-group-prepend">
                                                        <select class="form-control select" name="i_area" id="i_area" data-bgcolor="secondary" data-bgcolor-variation="lighten-3" data-text-color="white">
                                                            <option value="NA" <?php if ($i_area == 'NA') {
                                                                                    echo "selected";
                                                                                } ?>>NA - Nasional</option>
                                                            <?php if ($area->num_rows() > 0) {
                                                                foreach ($area->result() as $key) { ?>
                                                                    <option value="<?= $key->i_area; ?>" <?php if ($i_area == $key->i_area) {
                                                                                                                echo "selected";
                                                                                                            } ?>><?= $key->i_area_id . ' - ' . $key->e_area_name; ?></option>
                                                            <?php }
                                                            } ?>
                                                        </select>
                                                        <!-- <div class="input-group-prepend">
                                                            <button class="btn btn-secondary" required type="button"><i class="feather icon-map-pin"></i></button>
                                                        </div> -->
                                                    </div>
                                                </fieldset>
                                            </div>
                                            <div class="col-md-2">
                                                <fieldset>
                                                    <div class="input-group">
                                                        <button class="btn btn-block btn-secondary" type="submit"><i class="feather icon-search fa-lg"></i></button>
                                                    </div>
                                                </fieldset>
                                            </div>
                                        </div>
                            ...
                            <div class="table-responsive">
                                <table class="table table-xs display text-uppercase nowrap table-striped table-bordered font-small-3" id="serverside" width="100%;">
                                    <thead class="<?= $this->session->e_color;?> bg-darken-1 text-white">
                                        <tr>
                                            <th class="text-center" rowspan="2">Island</th>
                                    ...
                                    <tfoot>
                                        <tr>
                                            ...
                                            <th class="text-right"><b>Rp. <?= number_format($totprevvnota); ?></b></th>
                                            <th class="text-right"><b>Rp. <?= number_format($totvnota); ?></b></th>
