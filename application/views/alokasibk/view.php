                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                ...
                                                <div class="controls">
                                                    <input type="text" readonly value="<?= $data->e_supplier_name; ?>" class="form-control form-control-sm text-uppercase" maxlength="500" name="i_supplier" placeholder="<?= $this->lang->line("Pemasok"); ?>">
                                        ...
                                        <table class="table table-xs table-column table-bordered" id="tabledetail">
                                            <thead class="<?= $this->session->e_color; ?> bg-darken-1 text-white">
                                                <tr>
                                                    ...
                                                    <th class="text-center" width="20%"><?= $this->lang->line("No Nota"); ?></th>
                                                    <th class="text-center" width="15%"><?= $this->lang->line("Tgl Nota"); ?></th>
                                                    <th class="text-center" width="15%"><?= $this->lang->line("Nilai"); ?></th>
                                                    <th class="text-center" width="15%"><?= $this->lang->line("Bayar"); ?></th>
                                                    <!-- <th class="text-center" width="12%"><?= $this->lang->line("Sisa"); ?></th> -->
                                                    <!-- <th class="text-center" width="12%"><?= $this->lang->line("Lebih"); ?></th> -->
                                                    <th class="text-center" width="30%"><?= $this->lang->line("Keterangan"); ?></th>
                                                </tr>
                                            </thead>
                                            <tbody>
                                                <?php $i = 0;
