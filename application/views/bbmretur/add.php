                                    ...
                                    <div class="col-md-3">
                                        <div class="form-group">
                                            ...
                                            <div class="input-group input-group-sm controls">
                                                ...
                                                <input type="hidden" value="<?= date('Y-m-d'); ?>" readonly data-validation-required-message="<?= $this->lang->line("Required"); ?>" id="d_document" name="d_document" required>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea type="text" class="form-control" placeholder="<?= $this->lang->line("Keterangan"); ?>" name="e_remarkh"></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="text" class="form-control form-control-sm" value="<?= $key->i_product_id; ?>" readonly>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                ...
                                                                <input type="text" class="form-control form-control-sm" value="<?= $key->e_product_motifname; ?>" readonly>
                                                            </td>
                                                            <td>
                                                                <input type="text" class="form-control form-control-sm text-right" value="<?= $key->n_quantity; ?>" id="n_ttb<?= $i; ?>" name="n_ttb[]" readonly>
                                                            ...
                                                            <td>
                                                                <select data-nourut="<?= $i; ?>" required class="form-control select2-size-sm" name="i_product[]" id="i_product<?= $i; ?>">
                                                                    <option value="<?= $key->i_product1; ?>"><?= $key->i_product_id; ?></option>
                                                                </select>
                                                            </td>
                                                            <td>
                                                            ...
                                                            <td>
                                                                <input type="hidden" value="<?= $key->i_product1_grade; ?>" id="i_product_grade<?= $i; ?>" name="i_product_grade[]" readonly>
                                                                <input type="hidden" value="<?= $key->i_product1_motif; ?>" id="i_product_motif<?= $i; ?>" name="i_product_motif[]" readonly>
                                                            ...
                                                            <td>
                                                                <input type="text" class="form-control form-control-sm" placeholder="Note" value="" name="e_remark[]">
                                                            </td>
                                                        </tr>
                                                <?php }
                                                } ?>
