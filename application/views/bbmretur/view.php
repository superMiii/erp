                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <div class="controls">
                                                <textarea type="text" readonly class="form-control" placeholder="<?= $this->lang->line("Keterangan"); ?>" name="e_remarkh"><?= $data->e_remark; ?></textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                                    ...
                                                    foreach ($detail->result() as $key) {
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td><?= $key->i_product_id1; ?>
                                                                ...
                                                                <input type="hidden" class="form-control form-control-sm" value="<?= $key->i_product_id1; ?>" readonly>
                                                            </td>
                                                            <td><?= $key->e_product_name1; ?>
                                                                <input type="hidden" class="form-control form-control-sm" value="<?= $key->e_product_name1; ?>" readonly>
                                                            </td>
                                                            <td><?= $key->e_product_motifname1; ?>
                                                                ...
                                                                <input type="hidden" class="form-control form-control-sm" value="<?= $key->e_product_motifname1; ?>" readonly>
                                                            </td>
                                                            <td class="text-right"><?= $key->n_quantity1; ?>
                                                                <input type="hidden" class="form-control form-control-sm text-right" value="<?= $key->n_quantity1; ?>" id="n_ttb<?= $i; ?>" name="n_ttb[]" readonly>
                                                            ...
                                                            <td><?= $key->e_product_name; ?>
                                                                <input type="hidden" class="form-control form-control-sm" id="e_product_name<?= $i; ?>" value="<?= $key->e_product_name; ?>" readonly>
                                                            </td>
                                                            <td><?= $key->e_product_motifname; ?>
                                                                ...
                                                                <input type="hidden" class="form-control form-control-sm" value="<?= $key->e_product_motifname; ?>" id="e_product_motifname<?= $i; ?>" readonly>
                                                            </td>
                                                            <td class="text-right"><?= $key->n_quantity; ?><input type="hidden" value="<?= $key->n_quantity; ?>" autocomplete="off" class="form-control text-right n_bbm form-control-sm" id="n_bbm<?= $i; ?>" name="n_bbm[]" onkeypress="return bilanganasli(event);" onkeyup="cek(<?= $i; ?>)" onblur="if(this.value=='' ){this.value='0';}" onfocus="if(this.value=='0' ){this.value='' ;}"></td>
                                                            <td><?= $key->e_remark; ?>
                                                                <input type="hidden" class="form-control form-control-sm" placeholder="Note" value="<?= $key->e_remark; ?>" name="e_remark[]">
                                                            </td>
                                                        </tr>
                                                <?php }
                                                } ?>
