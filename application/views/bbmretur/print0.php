                    ...
                    <div class="card-body area-print">
                        ...
                        <div class="invoice-logo-title row">
                            <div class="col-9 d-flex flex-column justify-content-center align-items-start">
                                ...
                                <p class="font-large-2 text-uppercase text-primary"><?= $this->lang->line('Bukti Barang Masuk'); ?>
                                    <input type="hidden" id="id" value="<?= $data->i_bbm; ?>">
                                    <input type="hidden" id="path" value="<?= base_url($this->folder); ?>">
                                    <br><span class="font-medium-3 font-weight-bold">Nomor BBM : <?= $data->i_bbm_id; ?></span>
                                    <br><span class="font-medium-3 font-weight-bold">Tanggal BBM : <?= date('d', strtotime($data->d_bbm)) . ' ' . bulan(date('m', strtotime($data->d_bbm))) . ' ' . date('Y', strtotime($data->d_bbm)); ?></span>
                                </p>
                                <span class="font-medium-1 font-weight-bold">Nomor TTB : <?= $data->i_ttb_id; ?></span>
                                <span class="font-medium-1 font-weight-bold">Tanggal TTB : <?= date('d', strtotime($data->d_ttb)) . ' ' . bulan(date('m', strtotime($data->d_ttb))) . ' ' . date('Y', strtotime($data->d_ttb)); ?></span>

                            </div>
                            <div class="col-3 d-flex justify-content-end invoice-logo">
                                <img src="<?= base_url(); ?>assets/images/<?= $company->e_company_logo; ?>" alt="company-logo" height="171" width="241">
                            </div>
                        </div>
                        <hr class="mt-0 mb-0">
